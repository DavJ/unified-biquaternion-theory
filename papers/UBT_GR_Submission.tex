...
\begin{enumerate}
  \item \textbf{Metric is derived, not postulated.}
        ...
        The metric here is a bilinear of the fundamental field $\partial_\mu\Theta$,
        not the adjoint action of a rotor; no gravitational connection is presupposed.
  ...
  \item \textbf{Schwarzschild reproduced analytically and numerically.}
        ...
        the Schwarzschild metric follows analytically, with spatial components verified to
        $< 10^{-15}$ relative error via independent numerical computation.
...
Einstein equations & Variational, 5-step chain [\Lone] & --- & Einstein--Cartan, first-order \\
Complexified time $\tau=t+i\psi$ & Yes (compact $\psi$) & No & No \\
Schwarzschild recovery & Analytical + numerical $<10^{-15}$ & --- & PG form demonstrated \\
