...
the Zerilli equation (GAP-Z remains OPEN / FOLLOW-UP in this release; a candidate route is documented in \texttt{canonical/gr\_closure/zerilli\_derivation.tex} but is not counted as [L1] closure in v10.1.3).
...
The even-parity (Zerilli) equation is documented in the companion derivation
\texttt{canonical/gr\_closure/zerilli\_derivation.tex} (2026-05-10).
\end{abstract}
