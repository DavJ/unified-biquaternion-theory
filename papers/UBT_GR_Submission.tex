...
\subsection{Relation to the Hermitian Gravity Programme}
\label{subsec:hermitian_gravity}

UBT was developed independently, originating from a biquaternionic formulation
of electromagnetism (2013--2015), and was not motivated by the nonsymmetric or
Hermitian gravity programme.
Nevertheless, the two programmes converge structurally at the level of
employing a complexified metric on spacetime.

The historical programme begins with Einstein's introduction of a Hermitian
metric $g_{\mu\nu} = G_{\mu\nu} + iB_{\mu\nu}$ on real spacetime as a
unification ansatz~\cite{einstein1945,einstein_straus1946}.
Chamseddine later reformulated this setting as complex Hermitian spacetime
carrying a $\mathrm{U}(1,3)$ gauge
structure~\cite{chamseddine2001,chamseddine2006}.
The historical programme faced three fundamental obstacles:
(i)~the antisymmetric component $B_{\mu\nu}$ does not yield correct
electromagnetic field equations;
(ii)~no unifying symmetry principle governs the coupling of the symmetric and
antisymmetric sectors --- an absence explicitly noted by Einstein himself; and
(iii)~ghost instabilities appear at the nonlinear
level~\cite{damour_deser_mccarthy1992}.
Moffat's Nonsymmetric Gravitational Theory~\cite{moffat_ngt1995} continues
this line of research.

UBT addresses the missing symmetry principle by a different mechanism: gauge
fields arise from automorphisms of $\CC\otimes\HH$ acting on the tetrad, not
from antisymmetric metric components.
This algebraic origin supplies precisely the unifying symmetry principle whose
absence Einstein identified as the central obstruction.
No priority claim over any of the works cited above is implied.
...
\input{../canonical/gr_closure/schwarzschild_table}
