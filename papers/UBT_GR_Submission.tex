...
\begin{enumerate}
  ...
  \item \textbf{Spatial Schwarzschild reconstruction.}
        ...
        this relation from the field equation is open (GAP-U2).
...
single-action separation, the dynamically selected Jacobi sector, local metric representability/integrability, and global existence.  GAP-U2 now refers only to dynamical generation of the temporal
...
retained only as a possible effective-model analogy, not as closure of GAP-U2.
\end{tcolorbox}
...
GAP-U1 & Uniqueness of metric bilinear (alt.\ forms of $\langle\cdot,\cdot\rangle_\eta$); now also gates GAP-U2 closure; see \texttt{reviews/external\_review\_2026-07\_gpt.md} & High \\
\bottomrule
\end{tabular}
\end{center}
