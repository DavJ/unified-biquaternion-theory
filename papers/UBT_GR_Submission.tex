...
\]
This is a (up to gauge) spherically symmetric vacuum solution
...
GAP-U1 & Uniqueness of metric bilinear (alt.\ forms of $\langle\cdot,\cdot\rangle_\eta$); see \texttt{reviews/external\_review\_2026-07\_gpt.md} & Low \\
\bottomrule
\end{tabular}
\end{center}
