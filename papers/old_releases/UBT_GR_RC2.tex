...
\]
with an admissible indefinite bilinear form $\eta_B$ (the Lorentzian bilinear
form in the chosen spinor representation, with signature $(-,+,+,+)$, taken to
be non-degenerate and Hermitian on the projected GR sector).
...
It does not follow from complex time in isolation (without the admissible
