...
anti-commutation relations must also hold.
...
\emph{Normalization convention note}: this sign convention for $\calN$ is written explicitly
to keep $g_{00}<0$ and metric normalization internally consistent.
\end{definition}
...
It does not follow from complex time alone for arbitrary $\Theta$.
