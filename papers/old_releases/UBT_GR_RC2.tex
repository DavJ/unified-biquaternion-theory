...
form in the chosen spinor representation, with signature $(-,+,+,+)$).
The compact trace formula above is understood only after this Lorentzian
real-sector projection is applied.
\emph{RC2 safety note}: this sign convention for $\calN$ is written explicitly
...
bilinear form $\eta_B$ in the chosen representation).
