# Covariant Biquaternionic Tetrads in UBT — Abstract

The local classical geometry of UBT is formulated from the covariant first jet
`E_mu=N0^(-1/2)D_mu Theta` of the single biquaternionic field.  On the real
Lorentz slice, quaternion conjugation gives the exact central identity

`1/2(E_mu^sharp E_nu + E_nu^sharp E_mu) = g_munu 1`.

Thus the metric requires no trace, real-part projection, preferred imaginary-
time section, or compact-fiber average.  The nondegenerate tetrad-to-metric
