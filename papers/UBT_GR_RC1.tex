...
Subsequent results establish the fermion hypercharge assignments
$Y_Q=\frac{1}{6}$ from the topology of $S^1_\psi$ [L1], a conditional
derivation of $\sin^2\theta_W=\frac{3}{8}$ at the unification scale,
and anomaly cancellation for the SM-like chiral spectrum.
These results appear in companion files; the present paper is
self-contained on the gravitational sector.
\end{abstract}
