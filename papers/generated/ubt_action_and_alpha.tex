...
$SU(3)_c$ & Candidate construction & Internal phase fiber: $\Theta = \Xi\cdot\mathcal{U}$, $\mathcal{U}\in U(3)$; no octonions required (Appendix~G) \\
...
For the color sector, the candidate construction of Appendix~G
($\Theta = \Xi\cdot\mathcal{U}$, $\mathcal{U}\in U(3)$, traceless part $\to \mathfrak{su}(3)$)
provides a self-consistent non-octonionic framework.
Completing items 1--5 in its status box (formal Lie algebra emergence,
fundamental/adjoint representations, confinement, decoupling) remains the
primary open task for QCD.
