...
Kaluza--Klein reduction with the SU(2) Scherk--Schwarz twist route giving
$\Neff=12$.\\[4pt]
...
summation over $\Neff=12$ modes (from the SU(2) Scherk--Schwarz twist route [\Lone])
yields $B_0=(2\pi/3)\Neff=8\pi$.
The value $\Neff=12$ here is the SU(2)-twist result, not the
independent loop-counting route.
...
\texttt{research\_tracks/quantum\_ubt/su2\_twist\_neff12.tex} \Lone.
The NCG derivation provides an independent confirmation of the same SU(2)-twist route.
\end{remark}
...
This theorem does not identify $\Neff$ with the independent direct loop count,
which remains a separate open issue.
