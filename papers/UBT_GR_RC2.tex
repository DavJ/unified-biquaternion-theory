...
and numerically verified to relative error $< 5\times10^{-15}$
...
Schwarzschild recovery & Analytical + numerical $<5\times10^{-15}$ & Not demonstrated \\
...
error $< 5\times10^{-15}$ via \texttt{tools/verify\_schwarzschild\_theta.py}
...
All errors are below $5\times10^{-15}$; typical values are below $5\times10^{-16}$
