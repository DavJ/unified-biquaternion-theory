...
The GUT-embedding route (EW2) via generator norm ratios
$g'^2/g^2 = \sum Y^2/\sum T_3^2$ and one-loop RG running
gives $\sin^2\theta_W(M_Z)\approx 0.231$ conditionally on
the UBT fermion hypercharge assignments; see
\texttt{research\_tracks/EW/su5\_embedding\_test.tex}.
