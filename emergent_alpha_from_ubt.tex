...
\begin{equation}
S \propto \int_{\partial \Omega} |\psi_{\text{eff}}|^2 \, dA
\end{equation}
where $\partial \Omega$ is the boundary surface and $dA$ is the area element.
\end{conjecture}
...
As discussed in Section \ref{sec:emergence_alpha}, the solutions to the field equations in complex time are naturally expressed in terms of Jacobi theta functions $\vartheta(z; \tau)$. The holographic projection manifests as a reduction in the argument structure:
