...
\providecommand{\UBTStatusDisclaimer}{%
\begin{center}
...
\item \textbf{SM gauge group}: $SU(2)$ candidate and $U(1)$ derived from associative $\C \otimes \H$ sector; $SU(3)$ requires octonionic extension $\C \otimes \O$ (Track~B hypothesis, not yet proven necessary)
...
\medskip
\noindent\textbf{Biquaternionic Geometry Lock-in:} Throughout this work, all geometric and dynamical structures are defined at the biquaternionic level:

\begin{itemize}
\item \textbf{Metric:} The fundamental metric is $\mathcal{G}_{\mu\nu}(x) \in \mathbb{B}$, derived from biquaternionic tetrads $E_\mu$ via $\mathcal{G}_{\mu\nu} = \text{Sc}(E_\mu E_\nu^\dagger)$. The classical metric is only a projection: $g_{\mu\nu} := \text{Re}(\mathcal{G}_{\mu\nu})$.

\item \textbf{Connection:} The fundamental connection is $\Omega_\mu(x) \in \mathbb{B}$. Christoffel symbols are derived: $\Gamma^\lambda_{\mu\nu} = \text{Re}(\Omega^\lambda_{\mu\nu})$.

\item \textbf{Curvature:} The fundamental curvature is $\mathcal{R}_{\mu\nu} = \partial_\mu \Omega_\nu - \partial_\nu \Omega_\mu + [\Omega_\mu, \Omega_\nu]$. The Ricci tensor is: $R_{\mu\nu} := \text{Re}(\mathcal{R}_{\mu\nu})$.

\item \textbf{Stress-energy:} The fundamental tensor is $\mathcal{T}_{\mu\nu} = \langle D_\mu\Theta, D_\nu\Theta \rangle_\mathbb{B} - \frac{1}{2}\mathcal{G}_{\mu\nu}\langle D\Theta, D\Theta \rangle$. Classical stress-energy is: $T_{\mu\nu} := \text{Re}(\mathcal{T}_{\mu\nu})$.

\item \textbf{Field equations:} The fundamental equation is $\mathcal{G}_{\mu\nu} = \kappa \mathcal{T}_{\mu\nu}$ (biquaternionic). Einstein's equations arise only after $\text{Re}(\cdot)$ projection.
\end{itemize}

Any real-valued spacetime metric, curvature, or stress--energy tensor represents a Hermitian projection corresponding to an observer-restricted sector. No physical conclusion should be interpreted at the level of the real projection alone. General Relativity arises as the real projection of the fundamental biquaternionic geometry.

\medskip
\noindent\textbf{Future-proofing rule:} Any future extension of UBT must (i) define new dynamics at the biquaternionic level, (ii) state explicitly how the GR sector is obtained as $\text{Re}(\,\cdot\,)$, and (iii) avoid introducing classical GR objects (metrics $g_{\mu\nu}$, Christoffel symbols $\Gamma^\lambda_{\mu\nu}$, or stress--energy tensors $T_{\mu\nu}$) as axioms without such a projection. This applies to new appendices, phenomenological discussions, and experimental proposals.
...
\providecommand{\ConsciousnessDisclaimer}{%
\begin{center}
\fbox{\begin{minipage}{0.95\textwidth}
...
\providecommand{\AlphaDerivationDisclaimer}{%
\begin{center}
\fbox{\begin{minipage}{0.95\textwidth}
...
\providecommand{\SpeculativeContentWarning}{%
...
\providecommand{\GRCompatibilityNote}{%
