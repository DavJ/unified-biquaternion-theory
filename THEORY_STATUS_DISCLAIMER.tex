...
\medskip
\noindent\textbf{Biquaternionic lock-in:} Throughout this work, all geometric and dynamical structures are defined at the level of biquaternionic fields. Any real-valued spacetime metric, curvature, or stress--energy tensor represents a Hermitian projection corresponding to an observer-restricted sector. No physical conclusion should be interpreted at the level of the real projection alone.

\medskip
\noindent\textbf{Future-proofing rule:} Any future extension of UBT must (i) define new dynamics at the biquaternionic level, (ii) state explicitly how the GR sector is obtained as $\Re(\,\cdot\,)$, and (iii) avoid introducing classical GR objects as axioms without such a projection. This applies to new appendices, phenomenological discussions, and experimental proposals.
