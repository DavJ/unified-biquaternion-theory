...
| h_μν = 0 for single-mode winding vacuum | ✅ **Proved** | [`biquaternionic_vacuum_solutions.tex`](https://github.com/DavJ/unified-biquaternion-theory/blob/master/canonical/geometry/biquaternionic_vacuum_solutions.tex) |
| h_μν ≠ 0 two-mode winding vacuum | ✅ **Proved** | [`biquaternionic_vacuum_solutions.tex`](https://github.com/DavJ/unified-biquaternion-theory/blob/master/canonical/geometry/biquaternionic_vacuum_solutions.tex) |
