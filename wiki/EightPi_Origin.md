...
| Result | Status | File |
|--------|--------|------|
| 8π in G_μν = 8πG T_μν from dim(ℍ) | ❓ **Unknown** | [`8pi_common_origin.tex`](https://github.com/DavJ/unified-biquaternion-theory/blob/master/canonical/8pi_common_origin.tex) |
...
| Common algebraic ancestor: dim 4 | ❓ **Unknown** | [`8pi_common_origin.tex`](https://github.com/DavJ/unified-biquaternion-theory/blob/master/canonical/8pi_common_origin.tex) |
