...
| Θ-only closure (on-shell) | ⚠️ **GR-compatible sector (Level 2)** | <a href="https://github.com/DavJ/unified-biquaternion-theory/blob/master/canonical/gr_closure/step2_theta_only_closure.tex">`step2_theta_only_closure.tex`</a> |
