...
| Pure Θ-only closure (g substitution before variation, off-shell) | ✅ **Proved** | [`gr_offshell_rank_proof.tex`](https://github.com/DavJ/unified-biquaternion-theory/blob/master/research_tracks/research/gr_offshell_rank_proof.tex) |
