...
- Started (UTC): `2026-09-04T17:45:06+00:00`
- Commit: `696c37ed272c08ec741dd2e0214ad18aafeb0480`
- Ref: `master`
...
| failed | `canonical/alpha/best_candidate_derivation.tex` | `pdflatex` | 3.6 | `reports/latex_build/logs/canonical__alpha__best_candidate_derivation.tex__960f2b529e.txt` |
| failed | `canonical/alpha/nlogn_origin_analysis.tex` | `pdflatex` | 3.6 | `reports/latex_build/logs/canonical__alpha__nlogn_origin_analysis.tex__95cd85ef37.txt` |
| failed | `canonical/alpha/prime_stability_set.tex` | `pdflatex` | 3.9 | `reports/latex_build/logs/canonical__alpha__prime_stability_set.tex__f93542811d.txt` |
...
| failed | `canonical/interactions/B_base_derivation_complete.tex` | `pdflatex` | 3.7 | `reports/latex_build/logs/canonical__interactions__B_base_derivation_complete.tex__5a86e9c281.txt` |
| failed | `canonical/interactions/colour_charge_lattice.tex` | `pdflatex` | 4.0 | `reports/latex_build/logs/canonical__interactions__colour_charge_lattice.tex__b5e28d8b5e.txt` |
...
| failed | `docs/papers/papers/generated/neff_biquaternion.tex` | `pdflatex` | 2.0 | `reports/latex_build/logs/docs__papers__papers__generated__neff_biquaternion.tex__638216d52a.txt` |
...
| failed | `experiments/research_tracks/three_generations/st2_obstruction.tex` | `pdflatex` | 1.8 | `reports/latex_build/logs/experiments__research_tracks__three_generations__st2_obstruction.tex__2b502b6b7f.txt` |
...
| failed | `speculative_extensions/invisibility/st3_stability.tex` | `pdflatex` | 4.8 | `reports/latex_build/logs/speculative_extensions__invisibility__st3_stability.tex__2c52af72f2.txt` |
