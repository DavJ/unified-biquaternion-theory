...
- Started (UTC): `2026-08-21T17:24:42+00:00`
- Commit: `07860dd70afd9acc500478674c0b11097801ffbd`
- Ref: `master`
...
|---|---|---:|---:|---|
| failed | `ALPHA_BEST_ROUTE.tex` | `pdflatex` | 4.0 | `reports/latex_build/logs/ALPHA_BEST_ROUTE.tex__589d4d0ee6.txt` |
...
| failed | `canonical/appendices/appendix_ACTION_review.tex` | `pdflatex` | 3.5 | `reports/latex_build/logs/canonical__appendices__appendix_ACTION_review.tex__ebb0de13e5.txt` |
...
| failed | `canonical/gr_closure/linearised_gravity.tex` | `pdflatex` | 2.6 | `reports/latex_build/logs/canonical__gr_closure__linearised_gravity.tex__b165fac769.txt` |
...
| failed | `canonical/interactions/colour_charge_lattice.tex` | `pdflatex` | 4.1 | `reports/latex_build/logs/canonical__interactions__colour_charge_lattice.tex__b5e28d8b5e.txt` |
| failed | `canonical/interactions/hypercharge_assignments.tex` | `pdflatex` | 4.9 | `reports/latex_build/logs/canonical__interactions__hypercharge_assignments.tex__5d27954b87.txt` |
...
| failed | `canonical/n_eff/step1_mode_decomposition.tex` | `pdflatex` | 2.9 | `reports/latex_build/logs/canonical__n_eff__step1_mode_decomposition.tex__be7bf7f62d.txt` |
...
| failed | `docs/papers/papers/generated/neff_biquaternion.tex` | `pdflatex` | 2.6 | `reports/latex_build/logs/docs__papers__papers__generated__neff_biquaternion.tex__638216d52a.txt` |
...
| failed | `papers/old_releases/UBT_GR_RC2.tex` | `pdflatex` | 5.5 | `reports/latex_build/logs/papers__old_releases__UBT_GR_RC2.tex__e77ce2acd8.txt` |
...
| failed | `research_tracks/alpha_spectral/hecke_equivariant_path_integral.tex` | `pdflatex` | 5.3 | `reports/latex_build/logs/research_tracks__alpha_spectral__hecke_equivariant_path_integral.tex__a5b2ba4ac1.txt` |
...
| failed | `research_tracks/hecke_bridge/motivation.tex` | `pdflatex` | 5.2 | `reports/latex_build/logs/research_tracks__hecke_bridge__motivation.tex__43280cdcf2.txt` |
| failed | `research_tracks/prime_stability/rigorous_bounds.tex` | `pdflatex` | 2.6 | `reports/latex_build/logs/research_tracks__prime_stability__rigorous_bounds.tex__1ab5c9484b.txt` |
...
| failed | `research_tracks/quantum_ubt/frw_from_ubt.tex` | `pdflatex` | 5.1 | `reports/latex_build/logs/research_tracks__quantum_ubt__frw_from_ubt.tex__0a417648ba.txt` |
...
| failed | `research_tracks/T1_GR/ubt_gr_paper.tex` | `pdflatex` | 6.6 | `reports/latex_build/logs/research_tracks__T1_GR__ubt_gr_paper.tex__185f71aa01.txt` |
| failed | `research_tracks/T2_GAUGE/gauge_paper_draft.tex` | `pdflatex` | 5.5 | `reports/latex_build/logs/research_tracks__T2_GAUGE__gauge_paper_draft.tex__c4329718e6.txt` |
...
| failed | `research_tracks/T3_ALPHA/bootstrap_step_m1_conformal.tex` | `pdflatex` | 5.2 | `reports/latex_build/logs/research_tracks__T3_ALPHA__bootstrap_step_m1_conformal.tex__5ae58d3853.txt` |
| failed | `research_tracks/T3_ALPHA/bootstrap_step_m2_4point.tex` | `pdflatex` | 5.2 | `reports/latex_build/logs/research_tracks__T3_ALPHA__bootstrap_step_m2_4point.tex__7c7dde2094.txt` |
...
| failed | `research_tracks/T3_ALPHA/conditional_alpha_note_draft.tex` | `pdflatex` | 6.6 | `reports/latex_build/logs/research_tracks__T3_ALPHA__conditional_alpha_note_draft.tex__0c38280260.txt` |
| failed | `research_tracks/T3_ALPHA/hecke_alpha_connection.tex` | `pdflatex` | 6.0 | `reports/latex_build/logs/research_tracks__T3_ALPHA__hecke_alpha_connection.tex__92be42bc1e.txt` |
...
| failed | `research_tracks/T3_ALPHA/integer_137_note.tex` | `pdflatex` | 4.9 | `reports/latex_build/logs/research_tracks__T3_ALPHA__integer_137_note.tex__bd8b9177b6.txt` |
| failed | `research_tracks/T3_ALPHA/modular_bootstrap_attempt.tex` | `pdflatex` | 5.8 | `reports/latex_build/logs/research_tracks__T3_ALPHA__modular_bootstrap_attempt.tex__e2f2273ca7.txt` |
| failed | `research_tracks/T3_ALPHA/neff_protocol_derivation.tex` | `pdflatex` | 5.6 | `reports/latex_build/logs/research_tracks__T3_ALPHA__neff_protocol_derivation.tex__8b32fd54a2.txt` |
...
| failed | `research_tracks/T3_ALPHA/zeta_regularisation_B.tex` | `pdflatex` | 5.9 | `reports/latex_build/logs/research_tracks__T3_ALPHA__zeta_regularisation_B.tex__88ae2672b0.txt` |
...
| failed | `speculative_extensions/invisibility/st3_stability.tex` | `pdflatex` | 5.0 | `reports/latex_build/logs/speculative_extensions__invisibility__st3_stability.tex__2c52af72f2.txt` |
...
| failed | `speculative_extensions/UBT_HeckeWorlds_theta_zeta_primes_appendix.tex` | `pdflatex` | 3.2 | `reports/latex_build/logs/speculative_extensions__UBT_HeckeWorlds_theta_zeta_primes_appendix.tex__a4220eea4a.txt` |
