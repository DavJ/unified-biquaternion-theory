...
- Started (UTC): `2026-08-18T23:36:26+00:00`
- Commit: `f8a658b62a15c85334550c3c57eab0464eff916c`
- Ref: `master`
...
|---|---|---:|---:|---|
| failed | `ALPHA_BEST_ROUTE.tex` | `pdflatex` | 3.8 | `reports/latex_build/logs/ALPHA_BEST_ROUTE.tex__589d4d0ee6.txt` |
...
| failed | `canonical/gr_closure/zerilli_derivation.tex` | `pdflatex` | 4.9 | `reports/latex_build/logs/canonical__gr_closure__zerilli_derivation.tex__b1615d1fc5.txt` |
...
| failed | `canonical/THEORY/canonical/canonical_projection_rules.tex` | `pdflatex` | 0.8 | `reports/latex_build/logs/canonical__THEORY__canonical__canonical_projection_rules.tex__fd5e8e13be.txt` |
...
| failed | `docs/textbook/main.tex` | `pdflatex` | 4.2 | `reports/latex_build/logs/docs__textbook__main.tex__db3fc64b5d.txt` |
...
| failed | `research_tracks/T1_GR/GR_paper_v1.tex` | `pdflatex` | 6.5 | `reports/latex_build/logs/research_tracks__T1_GR__GR_paper_v1.tex__5042e7d545.txt` |
...
| failed | `research_tracks/T1_GR/ubt_gr_paper.tex` | `pdflatex` | 6.5 | `reports/latex_build/logs/research_tracks__T1_GR__ubt_gr_paper.tex__185f71aa01.txt` |
...
| failed | `research_tracks/T3_ALPHA/a4_explicit_computation.tex` | `pdflatex` | 3.7 | `reports/latex_build/logs/research_tracks__T3_ALPHA__a4_explicit_computation.tex__7b14117839.txt` |
| failed | `research_tracks/T3_ALPHA/bootstrap_step_m1_conformal.tex` | `pdflatex` | 5.1 | `reports/latex_build/logs/research_tracks__T3_ALPHA__bootstrap_step_m1_conformal.tex__5ae58d3853.txt` |
...
| failed | `research_tracks/T3_ALPHA/chowla_selberg_B_derivation.tex` | `pdflatex` | 3.8 | `reports/latex_build/logs/research_tracks__T3_ALPHA__chowla_selberg_B_derivation.tex__39e1ce0612.txt` |
...
| failed | `research_tracks/T3_ALPHA/modular_bootstrap_attempt.tex` | `pdflatex` | 5.7 | `reports/latex_build/logs/research_tracks__T3_ALPHA__modular_bootstrap_attempt.tex__e2f2273ca7.txt` |
...
| failed | `research_tracks/T3_ALPHA/vcw_exact_minimum.tex` | `pdflatex` | 6.1 | `reports/latex_build/logs/research_tracks__T3_ALPHA__vcw_exact_minimum.tex__67ed15f7f9.txt` |
| failed | `research_tracks/T3_ALPHA/zeta_regularisation_B.tex` | `pdflatex` | 5.8 | `reports/latex_build/logs/research_tracks__T3_ALPHA__zeta_regularisation_B.tex__88ae2672b0.txt` |
| failed | `speculative_extensions/causality/ctc_conditions.tex` | `pdflatex` | 4.9 | `reports/latex_build/logs/speculative_extensions__causality__ctc_conditions.tex__13bcb8fd6c.txt` |
...
| failed | `speculative_extensions/UBT_HeckeWorlds_theta_zeta_primes_appendix.tex` | `pdflatex` | 3.3 | `reports/latex_build/logs/speculative_extensions__UBT_HeckeWorlds_theta_zeta_primes_appendix.tex__a4220eea4a.txt` |
