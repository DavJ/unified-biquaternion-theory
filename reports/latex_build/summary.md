...
- Started (UTC): `2026-08-21T22:08:55+00:00`
- Commit: `c342f1eb92428dafe7759655c38b188a378c9516`
- Ref: `master`
...
|---|---|---:|---:|---|
| failed | `ALPHA_BEST_ROUTE.tex` | `pdflatex` | 4.1 | `reports/latex_build/logs/ALPHA_BEST_ROUTE.tex__589d4d0ee6.txt` |
| failed | `canonical/alpha/alpha_equation_matrix.tex` | `pdflatex` | 4.1 | `reports/latex_build/logs/canonical__alpha__alpha_equation_matrix.tex__d87dd6c173.txt` |
| failed | `canonical/alpha/best_candidate_derivation.tex` | `pdflatex` | 3.8 | `reports/latex_build/logs/canonical__alpha__best_candidate_derivation.tex__960f2b529e.txt` |
...
| failed | `canonical/alpha/symmetry_breaking_alpha_attempt.tex` | `pdflatex` | 3.7 | `reports/latex_build/logs/canonical__alpha__symmetry_breaking_alpha_attempt.tex__c0853dc650.txt` |
| failed | `canonical/alpha/veff_corrected.tex` | `pdflatex` | 4.2 | `reports/latex_build/logs/canonical__alpha__veff_corrected.tex__984f012719.txt` |
| failed | `canonical/appendices/appendix_ACTION_review.tex` | `pdflatex` | 3.4 | `reports/latex_build/logs/canonical__appendices__appendix_ACTION_review.tex__ebb0de13e5.txt` |
| failed | `canonical/appendices/appendix_alpha_geometry.tex` | `pdflatex` | 3.7 | `reports/latex_build/logs/canonical__appendices__appendix_alpha_geometry.tex__189a47cb2e.txt` |
| failed | `canonical/appendices/appendix_fermions_completion.tex` | `pdflatex` | 3.5 | `reports/latex_build/logs/canonical__appendices__appendix_fermions_completion.tex__e8a6ec7116.txt` |
...
| failed | `canonical/geometry/Rpsi_dynamical_fix.tex` | `pdflatex` | 3.5 | `reports/latex_build/logs/canonical__geometry__Rpsi_dynamical_fix.tex__bbaddff4eb.txt` |
| failed | `canonical/gr_closure/frw_cosmological_solutions.tex` | `pdflatex` | 2.8 | `reports/latex_build/logs/canonical__gr_closure__frw_cosmological_solutions.tex__a2130dbf85.txt` |
...
| failed | `canonical/n_eff/neff_reconciliation.tex` | `pdflatex` | 4.3 | `reports/latex_build/logs/canonical__n_eff__neff_reconciliation.tex__c370756446.txt` |
| failed | `canonical/n_eff/nhelicity_derivation.tex` | `pdflatex` | 4.3 | `reports/latex_build/logs/canonical__n_eff__nhelicity_derivation.tex__7be98f5b41.txt` |
| failed | `canonical/n_eff/step1_mode_decomposition.tex` | `pdflatex` | 2.8 | `reports/latex_build/logs/canonical__n_eff__step1_mode_decomposition.tex__be7bf7f62d.txt` |
...
| failed | `canonical/qed_phi_const/step3_beta_function.tex` | `pdflatex` | 2.6 | `reports/latex_build/logs/canonical__qed_phi_const__step3_beta_function.tex__d9d2dd1366.txt` |
...
| failed | `docs/papers/papers/generated/ubt_action_and_alpha.tex` | `pdflatex` | 1.7 | `reports/latex_build/logs/docs__papers__papers__generated__ubt_action_and_alpha.tex__9e6e532aae.txt` |
| failed | `docs/papers/papers/generated/ubt_cosmo_hecke_neff.tex` | `pdflatex` | 1.7 | `reports/latex_build/logs/docs__papers__papers__generated__ubt_cosmo_hecke_neff.tex__e8acfffd8a.txt` |
| failed | `docs/papers/papers/su3_triplet/arxiv_version.tex` | `pdflatex` | 1.6 | `reports/latex_build/logs/docs__papers__papers__su3_triplet__arxiv_version.tex__e38d2172d4.txt` |
...
| failed | `docs/textbook/main.tex` | `pdflatex` | 0.9 | `reports/latex_build/logs/docs__textbook__main.tex__db3fc64b5d.txt` |
...
| failed | `papers/old_releases/UBT_GR_RC2.tex` | `pdflatex` | 5.6 | `reports/latex_build/logs/papers__old_releases__UBT_GR_RC2.tex__e77ce2acd8.txt` |
| failed | `research_tracks/alpha_spectral/b_coefficient_gap_resolution.tex` | `pdflatex` | 5.2 | `reports/latex_build/logs/research_tracks__alpha_spectral__b_coefficient_gap_resolution.tex__5c40d893fd.txt` |
...
| failed | `research_tracks/alpha_spectral/self_dual_torus_derivation.tex` | `pdflatex` | 3.3 | `reports/latex_build/logs/research_tracks__alpha_spectral__self_dual_torus_derivation.tex__a6cef2356a.txt` |
...
| failed | `research_tracks/quantum_ubt/fermionic_sector_derivation.tex` | `pdflatex` | 3.7 | `reports/latex_build/logs/research_tracks__quantum_ubt__fermionic_sector_derivation.tex__1dcd10ba40.txt` |
| failed | `research_tracks/quantum_ubt/frw_from_ubt.tex` | `pdflatex` | 5.3 | `reports/latex_build/logs/research_tracks__quantum_ubt__frw_from_ubt.tex__0a417648ba.txt` |
...
| failed | `research_tracks/research/graviton_schwarzschild.tex` | `pdflatex` | 2.8 | `reports/latex_build/logs/research_tracks__research__graviton_schwarzschild.tex__0f5d5303f0.txt` |
| failed | `research_tracks/research/hecke_generation_structure.tex` | `pdflatex` | 2.7 | `reports/latex_build/logs/research_tracks__research__hecke_generation_structure.tex__dd450108e4.txt` |
...
| failed | `research_tracks/research/moduli_space_ads_vs_physical_ds.tex` | `pdflatex` | 2.6 | `reports/latex_build/logs/research_tracks__research__moduli_space_ads_vs_physical_ds.tex__1b3a33f971.txt` |
...
| failed | `research_tracks/T1_GR/GR_paper_v1.tex` | `pdflatex` | 6.7 | `reports/latex_build/logs/research_tracks__T1_GR__GR_paper_v1.tex__5042e7d545.txt` |
| failed | `research_tracks/T1_GR/ubt_gr_flagship.tex` | `pdflatex` | 5.0 | `reports/latex_build/logs/research_tracks__T1_GR__ubt_gr_flagship.tex__30191ff889.txt` |
...
| failed | `research_tracks/T3_ALPHA/chowla_selberg_B_derivation.tex` | `pdflatex` | 3.9 | `reports/latex_build/logs/research_tracks__T3_ALPHA__chowla_selberg_B_derivation.tex__39e1ce0612.txt` |
...
| failed | `research_tracks/T3_ALPHA/hecke_alpha_connection.tex` | `pdflatex` | 6.1 | `reports/latex_build/logs/research_tracks__T3_ALPHA__hecke_alpha_connection.tex__92be42bc1e.txt` |
...
| failed | `research_tracks/T3_ALPHA/integer_137_note.tex` | `pdflatex` | 5.0 | `reports/latex_build/logs/research_tracks__T3_ALPHA__integer_137_note.tex__bd8b9177b6.txt` |
| failed | `research_tracks/T3_ALPHA/modular_bootstrap_attempt.tex` | `pdflatex` | 5.9 | `reports/latex_build/logs/research_tracks__T3_ALPHA__modular_bootstrap_attempt.tex__e2f2273ca7.txt` |
| failed | `research_tracks/T3_ALPHA/neff_protocol_derivation.tex` | `pdflatex` | 5.7 | `reports/latex_build/logs/research_tracks__T3_ALPHA__neff_protocol_derivation.tex__8b32fd54a2.txt` |
| failed | `research_tracks/T3_ALPHA/vcw_exact_minimum.tex` | `pdflatex` | 6.3 | `reports/latex_build/logs/research_tracks__T3_ALPHA__vcw_exact_minimum.tex__67ed15f7f9.txt` |
...
| failed | `speculative_extensions/emergent_alpha_executive_summary.tex` | `pdflatex` | 3.9 | `reports/latex_build/logs/speculative_extensions__emergent_alpha_executive_summary.tex__9d8226c955.txt` |
...
| failed | `speculative_extensions/UBT_HeckeWorlds_theta_zeta_primes_appendix.tex` | `pdflatex` | 4.0 | `reports/latex_build/logs/speculative_extensions__UBT_HeckeWorlds_theta_zeta_primes_appendix.tex__a4220eea4a.txt` |
