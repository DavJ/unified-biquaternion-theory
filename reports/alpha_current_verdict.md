...
2. eta(i) remains **research/proposal**, not canonical closure.
3. eta(i) cannot be promoted until one of the following is closed:
   - Obstructions **O1–O3**, or
   - a valid **determinant-to-B insertion** from the action-level calculation.
