...
\begin{align}
    m_e &= \ElectronMassMeV \text{ MeV} \\
    m_\mu &= \MuonMassMeV \text{ MeV} \\
    m_\tau &= \TauMassMeV \text{ MeV}
\end{align}
...
\hline
Electron & 1 & 0.509856 & \ElectronMassMeV & 0.22\% \\
...
\begin{equation}
    \delta m_{\text{EM}}^{(e)} = m_e^{\text{exp}} - m_0^{(e)} = \ElectronMassMeV - 0.509856 = 0.001143 \text{ MeV}
\end{equation}
...
\begin{equation}
    ...
    \begin{aligned}
        ...
        \\
        \text{Electron:} \quad & m_e = \ElectronMassMeV \text{ MeV} \quad (\text{predicted: } 0.509856 \text{ MeV}) \\
        \text{Muon:} \quad & m_\mu = 105.66 \text{ MeV} \quad (\text{fitted}) \\
        \text{Tau:} \quad & m_\tau = \TauMassMeV \text{ MeV} \quad (\text{fitted}) \\
        \\
