...
\begin{equation}
    m_0^{(e)} = A = 0.5099 \text{ MeV}
\end{equation}

The electromagnetic self-energy correction is:
\begin{equation}
    \delta m_{\text{EM}}^{(e)} = m_e^{\text{exp}} - m_0^{(e)} = 0.5110 - 0.5099 = 0.0011 \text{ MeV}
\end{equation}
...
\begin{equation}
    R_e = \frac{\hbar c}{m_0^{(e)}} = \frac{197.327}{0.5099} \approx 387 \text{ fm} = 3.87 \times 10^{-13} \text{ m}
\end{equation}
...
\begin{enumerate}
    ...
    \item \textbf{Predicts electron mass} to 0.2\% accuracy without fitting
...
\begin{enumerate}
    \item Precise calculation of quark masses from discrete mode search
...
\begin{equation}
    ...
    \begin{aligned}
        ...
        & \text{with } A = 0.5099 \text{ MeV}, B = -14.099 \text{ MeV}, p = 7.4 \\
        \\
        \text{Electron:} \quad & m_e = 0.5110 \text{ MeV} \quad (\text{predicted: } 0.5099 \text{ MeV}) \\
