...
The unified field \(\Theta(q, \tau)\), defined on biquaternionic coordinates \(q\) and biquaternionic time \(\tau = t + i\psi\),
...
The biquaternionic time coordinate \(\tau = t + i\psi\) permits an interpretation where:
\begin{itemize}
...
\begin{itemize}
  \item Psychons are defined as localized, quantized excitations of \(\Theta(q, \tau)\) in biquaternionic time.
