...
\[
\alpha_{\text{exp}}^{-1} = \AlphaInvBest(21)
\]
Difference:
\[
...
The experimental value $\alpha_{\text{exp}}^{-1} = \AlphaInvBest(21)$ is measured at low energy (Thomson scattering limit, effectively $Q^2 \to 0$). At higher energies, such as the $Z$ boson mass scale, one finds $\alpha^{-1}(M_Z^2) \approx 128$.
