...
The stress-energy tensor $T_{\mu\nu}$ on the right-hand side is derived from the UBT matter action $S_{\mathrm{matter}}[\Theta, g]$ via the Hilbert (metric variation) prescription
\[
  T_{\mu\nu} = -\frac{2}{\sqrt{-g}}\,\frac{\delta S_{\mathrm{matter}}}{\delta g^{\mu\nu}},
\]
and is explicitly given by kinetic, potential, and gauge contributions from $\Theta$.
A detailed derivation, including the full Hilbert variation, the biquaternionic lift
$\mathcal{T}_{\mu\nu} = -(2/\sqrt{-g})\,\delta S[\Theta]/\delta g^{\mu\nu}$,
the projection $T_{\mu\nu} = \mathrm{Re}(\mathcal{T}_{\mu\nu})$, and the reduction
to the classical Klein--Gordon form, is provided in
...
The gauge group $SU(3) \times SU(2) \times U(1)$ of the Standard Model is partially connected to the biquaternionic structure. $SU(2)$ and $U(1)$ are candidates arising from the associative sector $\C \otimes \H$. $SU(3)$ appears upon extension to $\C \otimes \O$ (Octonionic Completion Hypothesis); it does \emph{not} follow from $\C \otimes \H$ alone. See Appendix~E2 and \texttt{research\_tracks/} for the dual-track research program.
...
\input{appendix_QB_quantum_bridge}
