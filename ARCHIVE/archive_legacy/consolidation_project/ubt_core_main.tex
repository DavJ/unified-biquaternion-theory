...
\input{appendix_FORMAL_qm_gr_unification}  % Task 1: Formal QM-GR unification
\input{appendix_FORMAL_emergent_metric}  % Task 2: Emergent metric and Einstein equation
\input{appendix_FORMAL_black_hole_radiation}  % Task 3: Black hole radiation via complex time
\input{appendix_FORMAL_constants_normalization}  % Task 4: Fundamental constants from normalization
...
\input{appendix_G5_biquaternionic_fokker_planck}  % NEW: Biquaternionic Fokker-Planck equation (2025)
