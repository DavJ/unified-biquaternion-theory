...
\begin{equation}
C_{\text{BCH}} \approx \frac{i}{2}(t^2 - \psi^2)[A,B] + O(t\psi)
\end{equation}
\end{theorem}

\textbf{Physical Interpretation}: Non-commutativity introduces additional phase factors that depend on both $t$ and $\psi$ quadratically.
