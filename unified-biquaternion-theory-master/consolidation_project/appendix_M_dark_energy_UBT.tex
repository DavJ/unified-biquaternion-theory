...
\paragraph{Note on Complex Time Approximation in Dark Energy.}
\textbf{Justification for using complex time $\tau = t + i\psi$}: Dark energy phenomenology uses the complex time approximation because: (1) Cosmological dynamics occur on very large scales where local commutators $[\Theta_i, \Theta_j] \approx 0$ are satisfied, (2) The phase field $\psi$ varies slowly compared to the Hubble time, satisfying $\|\mathbf{v}\|^2 \ll |\psi|^2$, and (3) The universe is approximately homogeneous and isotropic at large scales, where the complex time framework captures the essential vacuum energy dynamics. Inhomogeneous or anisotropic cosmologies (e.g., with strong primordial gravitational waves) may require the full biquaternionic time structure. See Appendix~\ref{sec:biquaternion_vs_complex_time}.
