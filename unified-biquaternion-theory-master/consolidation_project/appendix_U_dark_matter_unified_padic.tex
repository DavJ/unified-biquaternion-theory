...
% Appendix U: Dark Matter as Topological Excitations in $\Theta(q,\tau)$ Field
% ================================================================================

\section*{Appendix U \\ Dark Matter as Topological Excitations in \texorpdfstring{$\Theta(q,\tau)$}{Theta(q,tau)} Field}
\addcontentsline{toc}{section}{Appendix U: Dark Matter as Topological Excitations}

\paragraph{Note on Complex Time Approximation in Dark Matter.}
\textbf{Justification for using complex time $\tau = t + i\psi$}: The dark matter derivations in this appendix use complex time approximation. This is justified for the following reasons: (1) The topological hopfion configurations are primarily spatial structures where time evolution is adiabatic, making $\|\mathbf{v}\|^2 \ll |\psi|^2$ satisfied, (2) The phase coordinate $\psi$ plays a key role in decoupling dark matter from visible sector interactions, and (3) For non-relativistic dark matter (which constitutes most cosmological DM), the complex time framework captures the essential physics. However, for ultra-relativistic dark matter or strong-field scenarios near black holes, the full biquaternionic time structure may be required. See Appendix~\ref{sec:biquaternion_vs_complex_time} for complete criteria.
...
Then
\begin{align}
R_H &\sim \sqrt{\frac{\beta}{\alpha}} \;=\; \sqrt{\frac{0.5}{2.0}} \;\approx\; 0.5,\\
...
% ================================================================================
% Topological Modes and the Geometric Origin of Dark Matter
% ================================================================================
...
\subsection{P-adic Extension of Dark Matter (Rigorous Version)}
...
\paragraph{Explicit local factors and example.}
...
\section{P-adic Extension and Multiverse Sectors}
