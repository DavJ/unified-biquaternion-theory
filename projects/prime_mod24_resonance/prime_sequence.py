...
def main() -> None:
    ...
    ap.add_argument("--n", type=float, default=1e6,
                    help="Upper bound for prime sieve (default: 1e6)")
    ap.add_argument("--out", default="data/primes_mod24.parquet",
                    help="Output Parquet path (default: data/primes_mod24.parquet)")
    args = ap.parse_args()
