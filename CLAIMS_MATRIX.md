...
|---|---|---|---|
| Derived metric chain and GR recovery in admissible real projection | DERIVED_WITH_ASSUMPTIONS | `canonical/gr_closure/`, `papers/UBT_GR_Submission.tex` | Steps 1--4 proved; step 5 conditional on GAP-10; see also GAP-U2, GAP-B |
