...
|---|---|---|---|
| Pure-Theta metric chain and local GR closure in the compact-ψ sector | DERIVED_WITH_ASSUMPTIONS | `canonical/gr_closure/pure_ubt_fiber_closure.tex`, `papers/UBT_GR_Submission.tex` | Exact direct variation proved. Fixed-ψ section: rank NO-GO. Vacuum Einstein closure proved locally on regular fiber-free profiles; matter closure conditional on the direct internal equation. GAP-10S/J/R/G and GAP-U2Theta remain open; perturbations remain conditional on GAP-B. |
| Regge–Wheeler odd-parity graviton equation recovery | DERIVED_WITH_ASSUMPTIONS | `papers/UBT_GR_Submission.tex`, `canonical/gr_closure/` | Conditional reduction [L1 cond.]; bridge DERIVED via linearised fiber closure, conditional on the fiber-free Schwarzschild representer (GAP-10R) |
| Zerilli even-parity graviton equation recovery | DERIVED_WITH_ASSUMPTIONS | `canonical/gr_closure/zerilli_derivation.tex` | Conditional reduction [L1 cond.]; bridge DERIVED via linearised fiber closure, conditional on the fiber-free Schwarzschild representer (GAP-10R) |
