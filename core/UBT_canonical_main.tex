...
\input{core/geometry/biquaternion_tetrad.tex}
\input{core/geometry/biquaternion_metric.tex}
\input{core/geometry/biquaternion_connection.tex}
\input{core/geometry/biquaternion_curvature.tex}
\input{core/geometry/biquaternion_stress_energy.tex}
\input{core/geometry/exotic_regimes.tex}
...
\input{core/geometry/metric.tex}
...
\input{core/interactions/qed.tex}
...
\input{core/interactions/qcd.tex}
...
\input{core/interactions/sm_gauge.tex}
...
\input{core/explanation_of_nabla.tex}

\section{Symbol Dictionary}
\label{app:symbols}

% Include canonical symbol dictionary
\input{core/appendices/symbol_dictionary.tex}
