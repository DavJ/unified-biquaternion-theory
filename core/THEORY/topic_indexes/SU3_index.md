...
**Canonical file**: `consolidation_project/appendix_G_internal_color_symmetry.tex`
...
|----------|------|--------|
| `consolidation_project/appendix_G_internal_color_symmetry.tex` | **CANONICAL** — complete algebraic proof, Theorems G.A–G.D | PROVED [L0] ⭐ |
...
|----------|-------|---------|
| `consolidation_project/SU3_derivation/step1_involution_summary.tex` | **supporting** | Involution-based construction (the canonical approach, abbreviated) |
| `consolidation_project/SU3_derivation/step1_superposition_approach.tex` | **supporting** | Complementary derivation via quantum superposition over {I,J,K} |
| `consolidation_project/SU3_derivation/step3_SU3_result.tex` | **supporting** | Result compilation; cross-references to canonical |
...
|----------|-------|-------------------|
| `Appendix_G_Emergent_SU3.tex` | **heuristic / motivating sketch** | Maps i,j,k → r,g,b; intuitive but NOT an algebraic proof; see disclaimer inside that file |
| `THEORY_COMPARISONS/su3_qubit_mapping/` | **mathematical sandbox** | Valid Lie algebra homomorphism (51 tests pass); derives from a *different* starting point (qubit encoding, not ℂ⊗ℍ); not part of mainline UBT |
| `tools/scan_associative_su3_candidates.py` | **sandbox** | Parameter scan; no new result |
| `reports/associative_su3_scan.md` | **sandbox** | Scan results only |
...
| Document | Status |
|----------|--------|
| `consolidation_project/confinement/algebraic_confinement.tex` | **CONJECTURED with experimental support** |
| `consolidation_project/confinement/confinement_verification.py` | **supporting** (numerical verification) |
...
1. Read `consolidation_project/appendix_G_internal_color_symmetry.tex` (canonical proof, ~8 pages)
2. Run `tools/verify_su3_superposition.py` to numerically confirm all generators (< 1 second)
3. If interested in the heuristic motivation, consult `Appendix_G_Emergent_SU3.tex` with
...
4. For the qubit-encoding variant (unrelated to UBT first principles), see
   `THEORY_COMPARISONS/su3_qubit_mapping/README.md`
