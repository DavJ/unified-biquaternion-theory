...
\input{core/canonical/geometry/biquaternion_tetrad.tex}
\input{core/canonical/geometry/biquaternion_metric.tex}
\input{core/canonical/geometry/biquaternion_connection.tex}
\input{core/canonical/geometry/biquaternion_curvature.tex}
\input{core/canonical/geometry/biquaternion_stress_energy.tex}
\input{core/canonical/geometry/exotic_regimes.tex}
...
\input{core/canonical/geometry/metric.tex}
...
\input{core/canonical/interactions/qed.tex}
...
\input{core/canonical/interactions/qcd.tex}
...
\input{core/canonical/interactions/sm_gauge.tex}
...
\input{core/canonical/explanation_of_nabla.tex}

\section{Symbol Dictionary}
\label{app:symbols}

% Include canonical symbol dictionary
\input{core/canonical/appendices/symbol_dictionary.tex}
