...
\item $\tau = t + i\psi$ is biquaternionic time with real component $t$ and imaginary component $\psi$
...
This is the Dirac quantization condition adapted to the UBT biquaternionic time structure. The integer $n$ counts the winding number of the gauge field around the $\psi$ circle.
