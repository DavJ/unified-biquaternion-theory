...
\end{itemize}
These are equivalent under the mapping $(i,j,k) \leftrightarrow (\sigma_x, \sigma_y, \sigma_z)$ with $t_0=t$, $t_1=\psi$, $(t_2,t_3) \leftrightarrow \mathbf{v}_\perp$. Complex time $\tau = t + i\psi$ is the canonical formulation and corresponds to the case when vector components are negligible or averaged.
