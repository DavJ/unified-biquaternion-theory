...
\end{equation}
recovering the standard Jacobi theta function $\vartheta_3$ with biquaternionic time $\tau$.
...
When the system satisfies $[\Theta_i, \Theta_j] \to 0$ and $\mathbf{v} \to 0$, the formulation reduces to biquaternionic time $\tau = t + i\psi$ as shown in equation \eqref{eq:classical_limit}.
