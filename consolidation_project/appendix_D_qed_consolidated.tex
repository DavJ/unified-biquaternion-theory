...
\paragraph{UBT-QED Action.} The minimal UBT extension of QED with biquaternionic time reads
\begin{align}
...
In the framework of the Unified Biquaternion Theory (UBT), Quantum Electrodynamics (QED) is naturally embedded within a richer algebraic and geometric structure. The standard space-time coordinates are extended into a \emph{biquaternionic time} manifold
\begin{equation}
\tau = t + i \psi \,,
\end{equation}
