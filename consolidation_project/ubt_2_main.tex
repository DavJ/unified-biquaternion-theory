...
\input{appendix_JWST_LHC_predictions}
...
% REMOVED: Information-theoretic cosmology appendix moved to speculative_extensions/
% The IT appendix (Reed-Solomon codes, digital simulation analogies) is highly speculative
% and has been separated from core UBT to maintain scientific clarity.
% See: speculative_extensions/appendices/appendix_IT_information_theoretic_cosmology.tex
% For information-theoretic aspects that ARE part of core UBT (Ω_b derivation, Hubble tension
% as overhead hypothesis), see Layer B and Layer C documentation in main repository.
