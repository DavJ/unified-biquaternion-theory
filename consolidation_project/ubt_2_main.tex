...
While UBT introduces original constructs—biquaternionic time structure, biquaternionic unification, and consciousness–field coupling—it builds upon several well-established mathematical frameworks including quaternionic and octonionic algebras, gauge-group embeddings, and holographic correspondences. 
...
\item \textbf{Conceptual/exploratory frameworks}: Consciousness integration via psychon dynamics, p-adic multiverse interpretation, closed timelike curves, ab initio α derivation
\end{itemize}
...
\input{appendix_I_philosophical_coherence}
