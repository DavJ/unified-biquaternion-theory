...
When field components commute $[\Theta_i, \Theta_j] \to 0$ and when dynamics are dominated by a single imaginary direction (typically $\psi$), we can use the effective \textbf{biquaternionic time}:
\begin{equation}
T = t + i\psi,
