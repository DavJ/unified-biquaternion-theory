...
% Track: CORE — α derivation — v70 baseline
% Date: 2026-03-09
...
left-hand side of the self-consistency equation equals $1/(4\pi)$):
\begin{equation}
...
\begin{gap}
  ...
  \begin{enumerate}
    \item \emph{Algebraic origin of $R_\psi$ --- all four routes are dead ends.}
          ...
          gives $R_\psi^{\mathrm{SC}} \approx 0.196 \neq \pi/\sqrt{N_{\mathrm{eff}}}$,
