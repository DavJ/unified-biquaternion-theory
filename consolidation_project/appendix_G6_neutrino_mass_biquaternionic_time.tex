...
This appendix \textbf{derives the effective neutrino mass directly from biquaternionic time structure} (UBT priority), not from biquaternionic time. Complex time is understood only as a \textbf{projection limit} for didactic purposes or special regimes.
