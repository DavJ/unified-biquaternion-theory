...
% ───────────────────────────────────────────────────────────────────────────
\section{Testable Predictions from Algebraic Confinement}
\label{sec:testable}
% ───────────────────────────────────────────────────────────────────────────

The algebraic confinement conjecture makes the following predictions that are in
principle testable and distinguishable from the pure QCD/Clay-Prize picture:

\begin{enumerate}

\item \textbf{No isolated quarks in $\Hphys$}:
  All observable particles must satisfy $\langle C_2 \rangle = 0$ (colour singlet).
  This is the defining prediction of algebraic confinement and is consistent with
  all observations to date.  A single free quark (with $\langle C_2 \rangle = 4/3$)
  is algebraically excluded from $\Hphys$.

\item \textbf{Confinement scale $\sim 1/R_\psi$}:
  The UBT compactification radius $R_\psi$ sets the scale below which colour
  non-singlet states are energetically suppressed.  This predicts a relation
  between the compactification scale and $\Lambda_{\rm QCD}$:
  \begin{equation}
    \Lambda_{\rm QCD} \sim \frac{\hbar c}{R_\psi}.
  \end{equation}
  If $R_\psi$ can be computed from the UBT effective potential (a current open
  problem), this prediction becomes quantitative.

\item \textbf{Exotic hadrons (tetraquarks, pentaquarks) are allowed}:
  The admissibility condition $\langle C_2 \rangle = 0$ is satisfied by
  tetraquark $(q\bar{q}q\bar{q})$ and pentaquark $(qqqq\bar{q})$ configurations,
  as verified in Section~\ref{sec:verification}.
  The observation of exotic hadrons at LHCb (e.g., $\chi_{c1}(3872)$, $T_{cc}^+$,
  pentaquark $P_c$ states) is \emph{consistent with and predicted by}
  algebraic confinement.

\item \textbf{Falsifiability}: Algebraic confinement would be falsified by
  the direct observation of an isolated colour-charged state (a free quark or a
  colour-triplet particle).  This has not occurred in any collider experiment.

\end{enumerate}

\begin{statusbox}{Status: CONJECTURED WITH EXPERIMENTAL SUPPORT}
The algebraic confinement conjecture is consistent with:
\begin{itemize}
  \item All observed hadrons being colour singlets $\langle C_2 \rangle = 0$ ✓
  \item No observed free quarks ✓
  \item Exotic hadrons (tetraquarks, pentaquarks) observed at LHCb ✓
      (algebraically admissible states verified in Section~\ref{sec:verification})
\end{itemize}
Status updated from \textbf{CONJECTURED} to \textbf{CONJECTURED WITH EXPERIMENTAL SUPPORT}.
Note: This is experimental \emph{consistency}, not proof.  Peer review required.
\end{statusbox}
...
\bigskip
\noindent\textbf{Status:} Conjectured with experimental support [L0] ---
algebraically consistent, numerically verified, consistent with LHCb exotic hadron
observations; awaiting peer review.
