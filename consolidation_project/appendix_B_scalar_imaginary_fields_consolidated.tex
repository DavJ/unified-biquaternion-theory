...
\textbf{Complex Time as Effective Limit:} The simpler \textbf{complex time} $T = t + i\psi$ 
...
\begin{itemize}
\item When $\|\nabla_\perp \Theta\|^2 \ll \|\partial_t \Theta\|^2$: field dynamics are dominated by time evolution and the primary imaginary phase $\psi$; complex time $T = t + i\psi$ is sufficient.
...
\textit{Reference Tag:} \texttt{[TRANSITION\_CRITERION]} — All uses of complex time in subsequent sections must satisfy this criterion or explicitly acknowledge the approximation.
