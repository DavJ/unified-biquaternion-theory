...
\item \textbf{If modulation frequency $\omega_\psi$ inconsistent with biquaternionic time structure}: UBT falsified
...
where:
\begin{itemize}
\item $\delta_{\psi}$ is the biquaternionic time correction factor: $\delta_{\psi} = (2.3 \pm 0.8) \times 10^{-6}$
