...
\end{equation}
The \emph{UBT ansatz} relates $\alpha$ to a modular invariant built from theta constants evaluated at an \emph{effective biquaternionic time parameter} $\tau_\psi$,
\begin{equation}
...
The UBT biquaternionic time is $\tau=t+i\psi$ (Appendix~A). 
