...
\begin{gapbox}
\textbf{Gap Y2 (open):} The parameters $\mu$ and $\lambda$ in $V_\mathrm{eff}(\theta_0)$
...
Gap Y1 & Yukawa coupling $y$ not yet derived from $S[\Theta]$ \\
Gap Y2 & VEV $v$ not yet computed from $V_\mathrm{eff}$ without input \\
