...
The following assumptions are explicitly required for the theorem in this section.
They are labelled for clarity; none of them constitutes a new physics claim.
...
\begin{enumerate}[label=\textbf{A\arabic*.}]
  ...
  \item \textbf{Constant transformation.} $U\in\mathrm{SU}(3)_{V_c}$ is
    ...
    gauge invariance is addressed separately as a \emph{candidate extension}
    in \S\ref{sec:local_gauge}; it is \emph{not} proved here.
\end{enumerate}
