...
Canonical root-level implementation without an ARCHIVE runtime dependency.
Restored from the preserved legacy implementation on 2026-07-25; the legacy
copy remains unchanged for provenance and historical comparison.
