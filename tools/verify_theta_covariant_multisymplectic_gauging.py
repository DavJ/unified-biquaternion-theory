...
This verifies three theorem-critical algebraic facts:
...
2. at an explicit generic field value the infinitesimal group orbit has real
   dimension six;
3. therefore the moment-map constraints produced by a purely auxiliary
   symplectic connection leave only a two-dimensional symplectic-orthogonal
   subspace for D_mu Theta.
...
def verify() -> None:
    ...
    # Explicit generic rational/complex field value
    ...
    print("PASS: explicit generic orbit rank = 6")
