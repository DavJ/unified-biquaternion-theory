...
# Import the active root-level package.  This script lives under
# tools/forensic_fingerprint/tools, so tools/ is the package root.
_tools_root = Path(__file__).resolve().parents[2]
if str(_tools_root) not in sys.path:
    sys.path.insert(0, str(_tools_root))
from forensic_fingerprint.layer2.layer2_sweep import run_sweep
