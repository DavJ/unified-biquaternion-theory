...
$B_{\mathrm{obs}} = N_{\mathrm{eff}}^{3/2}(2\eta(i))^{c/12}$ & $\approx 46.281$ & HISTORICAL OBSERVATION & Numerical proximity only; rejected as first-principles $B$-modifier \\
\bottomrule
\end{tabular}
\end{center}
...
\textbf{Status update (2026-05-09)}: the $\eta(i)$ insertion route is
\emph{rejected as a first-principles modifier} of the $n\ln n$ coefficient $B$.
Any expression of the form
$B_{\mathrm{obs}} = N_{\mathrm{eff}}^{3/2}(2\eta(i))^{c/12} \approx 46.281$
is retained only as a historical numerical observation / partition-normalization
clue and does \textbf{not} close Gap G137-B.

See \texttt{reports/alpha\_eta\_i\_rejection.md} for the canonical rejection
verdict and guardrails.
\end{gapbox}
...
\begin{enumerate}
  ...
  \item Do not promote $n^* = 137$ to PROVED until Gap G137-B is formally resolved.
\end{enumerate}
