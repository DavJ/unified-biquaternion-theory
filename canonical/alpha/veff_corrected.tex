...
The missing normalisation factor is $R \approx 1.113$ where
$R = B_{\mathrm{phenom}}/B_{\mathrm{base}}$.
Primary attack path: modular bootstrap on $\hat{Z}(\tau) = \vartheta_3^3(\tau)$.
See \texttt{reports/alpha\_missing\_lemma.md}.
\end{gapbox}
