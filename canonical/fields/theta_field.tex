...
% Version: 2.0 (Updated for biquaternion time)
% Date: 2025-11-14
...
\Theta(q,T_B) \in \mathcal{B} = \mathbb{H} \otimes \mathbb{C}
\end{equation}
...
\textbf{Note}: For practical calculations, $\Theta$ can be represented as a $4 \times 4$ (or $8 \times 8$) complex matrix, but the canonical object is the biquaternion itself.
