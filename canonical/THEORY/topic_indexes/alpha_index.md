...
|----------|-------|-----------|
| `ARCHIVE/archive_legacy/consolidation_project/alpha_derivation/b_base_hausdorff.tex` | **supporting** | A2 (MOTIVATED CONJECTURE: exponent 3/2) |
| `ARCHIVE/archive_legacy/consolidation_project/alpha_derivation/b_base_spinor_approach.tex` | **supporting** | B_base via spinors |
| `ARCHIVE/archive_legacy/consolidation_project/alpha_derivation/b_base_delta_d.tex` | **supporting** | C1–C2 (DEAD END) |
| `ARCHIVE/archive_legacy/consolidation_project/alpha_derivation/b_base_nonpert.tex` | **supporting** | D1–D3 (DEAD END) |
| `ARCHIVE/archive_legacy/consolidation_project/alpha_derivation/b_base_new_directions.tex` | **supporting** | E1–E4 (partial) |
| `ARCHIVE/archive_legacy/consolidation_project/alpha_derivation/b_base_ncg_a4.tex` | **supporting** | F1–F4 (partial) |
| `ARCHIVE/archive_legacy/consolidation_project/alpha_derivation/b_base_g_approaches.tex` | **supporting** | G1–G7 (partial) |
| `ARCHIVE/archive_legacy/consolidation_project/alpha_derivation/b_base_kac_moody_level.tex` | **supporting** | H1–H3: k=1 motivated conjecture |
| `ARCHIVE/archive_legacy/consolidation_project/alpha_derivation/r_factor_geometry.tex` | **supporting** | R-factor geometry (OPEN) |
...
|----------|-------|-------------------|
| `ARCHIVE/archive_legacy/tex/emergent_alpha_calculations.tex` | **sandbox** | Exploratory; superseded by STATUS_ALPHA.md |
| `ARCHIVE/archive_legacy/tex/emergent_alpha_from_ubt.tex` | **sandbox** | Earlier narrative; superseded |
| `speculative_extensions/emergent_alpha_executive_summary.tex` | **sandbox** | Old executive summary; STATUS_ALPHA.md is current |
| `ARCHIVE/archive_legacy/tex/appendix_C_geometry_alpha.tex` | **historical** | Earlier geometry approach; documentation only |
| `ARCHIVE/archive_legacy/tex/appendix_C_geometry_alpha_v2.tex` | **historical** | V2 of same; not canonical |
| `ARCHIVE/archive_legacy/tex/alpha_padic_executive_summary.tex` | **sandbox** | p-adic extension; speculative |
...
| `docs/reports/alpha_derivation_trace.md` | **historical** | Earlier derivation trace |
| `docs/reports/alpha_audit/alpha_paths.md` | **historical** | Path map superseded by STATUS_ALPHA.md §9 |
...
| Script | Role | Output |
|--------|------|--------|
| `experiments/validation/validate_B_coefficient.py` | Non-circularity test | Confirms different N_eff → different n* |
| `experiments/alpha_core_repro/alpha_two_loop.py` | Two-loop reproduction | `experiments/alpha_core_repro/out/alpha_two_loop_grid.csv` |
| `experiments/validation/validate_alpha_renormalization.py` | Renormalisation validation | Quantitative check |
...
|--------|-------------|--------------|-------|
| G3-k | Kac-Moody level k from S[Θ] | k=1 (MOTIVATED CONJECTURE via H2) | `ARCHIVE/archive_legacy/consolidation_project/alpha_derivation/b_base_kac_moody_level.tex` |
| G-exp | 3/2 exponent in B_base = N_eff^{3/2} | Structural from real Gaussian on Im(ℍ) | `b_base_hausdorff.tex §4` |
| G-R | R ≈ 1.114 correction factor | Best candidate: 1+α(N_eff+π+1/4) ≈ 1.1123 (0.15%) | `ARCHIVE/archive_legacy/consolidation_project/alpha_derivation/r_factor_geometry.tex` |
| G8 | Modular weight of Ẑ(τ) | Open | `ARCHIVE/archive_legacy/consolidation_project/alpha_derivation/b_base_g_approaches.tex` |
