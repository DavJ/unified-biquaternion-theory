...
\begin{itemize}
    ...
    \item $S_{\mu\nu} \in \mathbb{R}$ is the \textbf{phase energy-momentum} (dark energy; speculative auxiliary sector)
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Internal auxiliary sector energy (speculative interpretations in \texttt{speculative\_extensions/})
...
\noindent where:
\begin{itemize}
    \item $\mathcal{E}_{\mu\nu} = \mathcal{R}_{\mu\nu} - \frac{1}{2}\mathcal{G}_{\mu\nu}\mathcal{R}$ is the biquaternionic Einstein tensor (note $\mathcal{G}_{\mu\nu}$ in this expression is the metric)
...
\begin{enumerate}
    ...
    \item \textbf{Speculative note}: Consciousness/psychon interpretations are speculative and not part of core UBT.
