...
\hline
$E_\mu$ & Covariant UBT tetrad & $E_\mu=\mathcal N_0^{-1/2}D_\mu\Theta$ \\
\hline
$\Gamma^\rho{}_{\mu\nu}$ & Coordinate/affine connection & Acts on spacetime indices \\
\hline
$\omega_\mu{}^a{}_b$ & Lorentz-frame connection & $\omega=\mathring\omega(e)+K(T)$ for specified torsion \\
\hline
$\Omega_\mu$ & Spin/biquaternionic lift of $\omega_\mu$ & Representation-dependent; not $\operatorname{Re}^{-1}\Gamma$ \\
\hline
...
\begin{enumerate}
    ...
    \item ❌ Defining the metric by a trace, real-part, phase, fiber, or embedding readout instead of the central tetrad identity
\end{enumerate}
