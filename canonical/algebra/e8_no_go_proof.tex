...
\begin{itemize}
  \item[\textbf{KILLED}] $E_8$ lattice from $\mathcal{B}$: no natural embedding exists
        (Theorem~\ref{thm:e8:no_go}, three independent obstructions, [L0]).
  \item[\textbf{KILLED}] E8 sphere-packing density $\pi^4/384$ as normalization:
  ...
  \item[\textbf{KILLED}] E8 torus realization $T^8 = \mathbb{R}^8/\Lambda_{E_8}$:
