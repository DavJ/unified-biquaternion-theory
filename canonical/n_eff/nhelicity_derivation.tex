...
\section{Final verdict update (2026-05-12): SU(2) twist closure}
\label{sec:su2-update}
The SU(2) Scherk--Schwarz twist derivation in
\texttt{research\_tracks/quantum\_ubt/su2\_twist\_neff12.tex}
upgrades the helicity factor to
\(N_{\mathrm{helicity}}=2\) for the charged anti-periodic off-diagonal sector.

\begin{statusbox}
Final verdict update: \(N_{\mathrm{helicity}}=2\) from SU(2) twist for charged off-diagonal fields.\\
Klasifikace: \textbf{[L1]} for \(N_{\mathrm{helicity}}=2\) in the SU(2)-twisted KK route.\\
Dopad: \(N_{\mathrm{eff}}=12\), \(B_0=8\pi\) in that route.\\
