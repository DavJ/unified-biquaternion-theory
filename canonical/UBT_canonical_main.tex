...
\input{canonical/geometry/biquaternion_tetrad.tex}
\input{canonical/geometry/biquaternion_metric.tex}
\input{canonical/geometry/biquaternion_connection.tex}
\input{canonical/geometry/biquaternion_curvature.tex}
\input{canonical/geometry/biquaternion_stress_energy.tex}
\input{canonical/geometry/exotic_regimes.tex}
...
\input{canonical/geometry/metric.tex}
...
\begin{itemize}
    ...
    \item Consciousness substrate (phase coupling)
\end{itemize}
...
\input{canonical/interactions/qed.tex}
...
\input{canonical/interactions/qcd.tex}
...
\input{canonical/interactions/sm_gauge.tex}
...
\input{canonical/explanation_of_nabla.tex}

\section{Symbol Dictionary}
\label{app:symbols}

% Include canonical symbol dictionary
\input{canonical/appendices/symbol_dictionary.tex}
