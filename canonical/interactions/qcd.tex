...
In UBT, the $SU(3)$ color symmetry \textbf{emerges} from the internal structure of the $\Theta$ field:
...
This naturally produces $SU(3)$ gauge structure without postulating it \textit{a priori}.
...
This canonical QCD Lagrangian provides the emergent strong interaction theory within UBT, where $SU(3)$ color symmetry arises naturally from biquaternion field structure rather than being postulated.
