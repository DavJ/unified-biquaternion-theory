...
$A=\Omega$, $B=-\Omega^\ddagger$ is not the generic solution: it implies a
concurrent vector and excludes Schwarzschild with nonzero mass.  See
\texttt{canonical/gr\_closure/gap\_10i\_paired\_connection\_audit.tex}.
...
\medskip
\textbf{GAP-10I-CURVED: NARROWED.}  Self-consistent on-shell generation,
