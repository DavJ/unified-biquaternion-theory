...
This note records a candidate route toward the Zerilli equation but is not counted as [L1] closure in v10.1.3.
GAP-Z remains OPEN / FOLLOW-UP in this release.
\end{abstract}
