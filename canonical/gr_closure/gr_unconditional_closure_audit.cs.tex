...
implikaci; neodvozuje dráhovou míru ani nedokazuje spektrální stabilitu.

\textbf{LEAN-PROVED PRO ZAKÓDOVANÉ ALGEBRAICKÉ JÁDRO.} Lean 4.33.1 s Mathlib
4.33.1 kernelově ověřuje nedegenerovanou čtyřrozměrnou kontrakci v
...
manifest a cíl CI činí výsledek reprodukovatelným. Tyto věty dokazují pouze
důsledky svých explicitních formálních premis; neformalizují ani neodvozují
mikroskopickou dráhovou míru, kompozitní Hessián nebo fyzikální stabilitu
$\psi$.
