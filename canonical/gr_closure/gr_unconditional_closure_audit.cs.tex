...
\textbf{LEAN-PENDING.} Repozitář obsahuje izolované experimentální Lean
zdrojové soubory, ale v tomto checkoutu nemá Lean toolchain, manifest projektu
ani cíl CI. Věta proto není označena jako ověřená v Leanu. Budoucí formalizace
musí zakódovat nezávislost kinematických predikátů na koeficientu akce a
nedegenerovanou čtyřrozměrnou kontrakci.
