...
where:
\begin{itemize}
    \item $\mathcal{E}_{\mu\nu} = \mathcal{R}_{\mu\nu} - \frac{1}{2}\mathcal{G}_{\mu\nu}\mathcal{R}$ is the biquaternionic Einstein tensor (defined from biquaternionic curvature $\mathcal{R}_{\mu\nu}$; note $\mathcal{G}_{\mu\nu}$ here is the metric)
