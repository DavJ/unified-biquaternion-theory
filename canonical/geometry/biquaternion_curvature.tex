...
\textbf{Do NOT simplify} commutators or assume associativity. Biquaternionic multiplication is generally non-associative: $(AB)C \neq A(BC)$ in general. The full algebraic structure must be preserved.
