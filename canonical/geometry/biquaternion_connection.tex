...
\textbf{Critical}: Do NOT assume commutativity of $\Omega_\mu$ and $E_\nu$. Do NOT simplify associators (terms like $[A,B,C] = (AB)C - A(BC)$ for biquaternions $A, B, C$). The full non-commutative, non-associative structure must be preserved.
...
In classical GR with Levi-Civita connection, torsion vanishes:
\begin{equation}
...
The connection reduces to the classical Levi-Civita connection:
