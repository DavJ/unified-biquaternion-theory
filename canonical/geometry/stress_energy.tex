% Canonical Stress-Energy Tensor Definition
% Version: 1.0
% Date: 2025-11-14
% Status: Canonical - DO NOT DUPLICATE

\section{The Stress-Energy Tensor $T_{\mu\nu}$}
\label{sec:canonical:stress_energy}

\subsection{Canonical Definition}

The energy-momentum (stress-energy) tensor for the biquaternion field $\Theta(q,\tau)$ is:

\begin{equation}
\label{eq:canonical:stress_energy}
...
The stress-energy tensor sources spacetime curvature via:

\begin{equation}
\label{eq:canonical:einstein_field}
R_{\mu\nu} - \frac{1}{2} g_{\mu\nu} R = 8\pi G T_{\mu\nu}
\end{equation}
...
\textbf{Canonical resolution}: Use Eq.~\ref{eq:canonical:stress_energy} derived from standard field theory Lagrangian via Noether's theorem.
