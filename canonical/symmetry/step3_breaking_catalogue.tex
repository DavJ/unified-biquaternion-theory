...
\textbf{Status: CONDITIONAL / CANDIDATE.}
Parity violation follows only if the minimal UBT action gauges $SU(2)_L$ but not $SU(2)_R$;
the absence of a right-handed $W_R$ coupling has not been derived from first principles
and remains an input assumption at this stage.
...
UBT is CPT-compatible in the real sector under locality,
Lorentz-compatibility, Hermiticity, and antiunitary-$T$ assumptions.
...
\begin{itemize}
  ...
  \item \textbf{$CPT$ invariance}: holds for all physical terms
    (CPT-compatible in the real sector under locality, Lorentz-compatibility,
    Hermiticity, and antiunitary-$T$ assumptions).
