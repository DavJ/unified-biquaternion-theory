...
%──────────────────────────────────────────────────────────────────────────────
\subsection*{Systematický scan kombinací $\eta$, $\vartheta_2$, $\vartheta_3$, $\vartheta_4$}
#──────────────────────────────────────────────────────────────────────────────

\subsection*{Systematický scan modulárních kombinací — nový výsledek}
%──────────────────────────────────────────────────────────────────────────────

Byl proveden přesný numerický scan všech kombinací tvaru
\[
B = 12^{3/2} \bigl[\eta(i)^a\,\vartheta_2(i)^b\,\vartheta_3(i)^c\,
\vartheta_4(i)^d\bigr]^{1/4}
\]
pro $a,b,c,d\in\{-2,-\tfrac{3}{2},-1,-\tfrac{1}{2},0,\tfrac{1}{2},1,
\tfrac{3}{2},2\}$ (celkem $9^4 = 6561$ kombinací).

\textbf{Výsledek}: Pro $(a,b,c,d)=(-2,\,0,\,1,\,2)$ dostaneme
$B = B_{\rm target}$ s chybou $< 10^{-13}$ (strojová přesnost):
\[
\boxed{B = 12^{3/2}\,\bigl[\eta(i)^{-2}\cdot\vartheta_3(0|i)
\cdot\vartheta_4(0|i)^2\bigr]^{1/4}.}
\]

\subsection*{Algebraický důkaz identity $\eta^{-2}\vartheta_3\vartheta_4^2 = 2\eta$ při $\tau=i$}
