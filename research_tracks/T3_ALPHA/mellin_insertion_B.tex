...
\[
S_{\mathrm{eff}}[n] = -\ln\!\int D\delta\Theta\,\exp(-S[\Theta_n+\delta\Theta])
= S[\Theta_n] + \frac12 \mathrm{Tr}\!\left[\ln\!\left(\left.\frac{\delta^2S}{\delta\Theta^2}\right|_{\Theta_n}\right)\right].
\]
...
\[
V_{1\mathrm{loop}}(n)=-\zeta'_{P_n}(0).
\]
At the self-dual point, the Mellin kernel links to $\vartheta_3(0|i)$ and
the target identification is
$g(\vartheta_3(0|i))=B/N_{\mathrm{eff}}^{3/2}$ for the $n\ln n$ term.
