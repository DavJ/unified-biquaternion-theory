...
\]
If this is proved from the canonical Layer2 projection rules, the determinant
sign is fermionic and the alpha chain can be promoted to PROVEN within canonical
UBT assumptions.  If it cannot be proved, use the explicit EW-breaking postulate
fallback.
\end{resultbox}
