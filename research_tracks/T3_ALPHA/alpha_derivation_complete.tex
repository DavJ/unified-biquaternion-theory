...
The physical identification of the winding stationary index~$n$ with $\alpha^{-1}$ is now closed conditionally by compact-U(1) EM modular normalisation, primitive electroweak EM projection, the $\Theta_0$ vacuum-orbit theorem, and the non-zero electroweak-minimum theorem.  The remaining structural condition is the UV derivation of the symmetry-breaking sign $\mu_{\rm EW}^2>0$ from the full canonical $S[\Theta]$.
\end{abstract}
...
\textbf{Final bridge}: physical identification $n=\alpha^{-1}$ is closed conditionally by compact-U(1) EM modular normalisation, primitive EM projection, the $\Theta_0$ electroweak-vacuum orbit theorem, and the non-zero EW-minimum theorem.  The remaining UV condition is to derive the symmetry-breaking sign $\mu_{\rm EW}^2>0$ from the full canonical $S[\Theta]$.
\end{resultbox}
