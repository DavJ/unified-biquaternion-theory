...
The final bridge is no longer a numerical assumption.  It is a structural
condition: the UBT electromagnetic projection must be the compact unit-charge
U(1)$_{\rm EM}$ bundle of the low-energy theory.  The full electroweak
projection theorem remains the natural place to promote this conditional
closure to a canonical theorem.
\end{remark}
...
\textbf{Final bridge}: physical identification $n=\alpha^{-1}$ is closed conditionally by compact-U(1) EM modular normalisation; remaining work is the full electroweak projection theorem.
\end{resultbox}
