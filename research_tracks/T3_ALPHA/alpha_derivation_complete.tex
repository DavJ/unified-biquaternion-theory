...
The physical identification of the winding stationary index~$n$ with $\alpha^{-1}$ is now closed conditionally by compact-U(1) EM modular normalisation, primitive electroweak EM projection, and the $\Theta_0$ vacuum-orbit theorem.  The remaining structural condition is the existence of a non-zero electroweak doublet minimum of $V(\Theta)$.
\end{abstract}
...
\textbf{Final bridge}: physical identification $n=\alpha^{-1}$ is closed conditionally by compact-U(1) EM modular normalisation, primitive EM projection, and the $\Theta_0$ electroweak-vacuum orbit theorem.  The remaining structural condition is the existence of a non-zero electroweak doublet minimum of $V(\Theta)$.
\end{resultbox}
