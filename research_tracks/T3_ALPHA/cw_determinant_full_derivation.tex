...
\approx 46.283$ agrees with $B_{\mathrm{required}} \approx 46.284$ to
$<0.003\%$.
\end{infobox}
...
$B_{\mathrm{obs}} = N_{\mathrm{eff}}^{3/2}(2\eta(i))^{1/4} \approx 46.283$
  & \OBS & 0.003\% from $B_{\mathrm{required}}$ \\
...
\begin{enumerate}
  ...
  \item The formula $B_{\mathrm{obs}} = N_{\mathrm{eff}}^{3/2}(2\eta(i))^{c/12}
        \approx 46.283$ matches $B_{\mathrm{required}} = 46.284$ to $<0.003\%$
        without any free parameter or circular input.
