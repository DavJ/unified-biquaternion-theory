...
\]
Together with the \(\Theta_0\) vacuum-orbit theorem, the remaining alpha proof
condition is reduced further to the existence of the symmetry-breaking minimum:
\[
  \boxed{
...
arbitrary identification.  Under the non-zero minimal electroweak doublet
minimum condition, the \(\Theta_0\) vacuum-orbit theorem supplies the standard
vacuum representative and this theorem supplies the primitive compact
unit-charge \(U(1)_{\rm EM}\).  This removes the possible free normalisation
factor in \(n=\alpha^{-1}\).
\end{resultbox}
