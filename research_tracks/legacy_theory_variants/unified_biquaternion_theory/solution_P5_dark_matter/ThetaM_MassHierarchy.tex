...
\author{UBT Legacy Research Draft} % originally styled as ThetaComm Research Group; not a ThetaComm claim
\date{\today}

% Status note: this is a legacy research-track draft about topological mass hierarchy.
% The historical author label "ThetaComm Research Group" has been removed to avoid
% confusing this draft with the non-canonical ThetaComm consciousness-communication
% hypothesis, which is quarantined under speculative_extensions/thetacomm/.
