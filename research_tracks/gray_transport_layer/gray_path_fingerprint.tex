...
\begin{proposition}[Single-error detection by Hamming weight-1 stabilizer]
...
\begin{remark}
This is precisely the stabilizer property relevant to L2S: the Hamming
weight-1 constraint protects color state identity against single-qubit errors.
It is a special case of the extended Hamming $(8,4,4)$ syndrome test applied
to a 3-bit sub-block.
\end{remark}
...
\item \textbf{No conflict}: one-hot triqubit stabilizer logic is preserved.
