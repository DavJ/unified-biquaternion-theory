...
\textbf{Prime 162 is not prime} (divisible by 2), so $p = 157$ remains stable
by the actual prime distribution.  The ``accident'' that 163 is prime and
not 162 is responsible for the stability of $p = 157$.
