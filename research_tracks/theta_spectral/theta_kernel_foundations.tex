...
\begin{proof}
  ...
  $\zeta_{A_0}'(0) = -2\ln(2\pi)\zeta_R(0) + 2\zeta_R'(0)
  = \ln(2\pi) + 2\zeta_R'(0)$.  Using $\zeta_R'(0) = -\frac12\ln(2\pi)$:
  $\zeta_{A_0}'(0) = \ln(2\pi) - \ln(2\pi) = 0$??  Actually $\det(A_0) = e^{-\zeta'(0)} = e^{-0} = 1$
  for the normalised operator.  The formula $\det(A_0) = (2\pi)^2$ includes
  the zero-mode volume factor $L^2 = (2\pi)^2$.
\end{proof}
