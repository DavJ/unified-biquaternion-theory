...
%------------------------------------------------------------
\section{2026-08-19 cross-link: two distinct prime mechanisms}
%------------------------------------------------------------

The working synthesis
\texttt{theta\_mellin\_feynman\_prime\_synthesis\_2026-08-19.md}
separates two mechanisms that should not be conflated:
\begin{enumerate}
  \item the present section's trace/orbit programme, which would require primitive
        UBT orbit data with logarithmic lengths $\ln p$; and
  \item the rational-time theta-revival programme, where quadratic Gauss sums factor
        by the Chinese remainder theorem and prime powers arise as irreducible
        denominator blocks of the theta dynamics.
\end{enumerate}
The second route does not close the ``UBT prime orbits'' gap.  It supplies an independent
candidate mechanism to test against the existing UBT $\alpha$ prime sectors.
