...
\begin{statusbox}
Three light generations from $n=1,2,3$: \textbf{[L0]} (winding structure)\\
$n\geq 4$ as heavy KK excitations ($m_n\sim nM_{\rm Pl}$): \textbf{[MC]}\\
First-principles proof that only 3 light generations: \textbf{[OPEN]}\\
Algebraic selection rule forbidding $n\geq 4$: \textbf{[NO DERIVATION]}\\
\end{statusbox}
