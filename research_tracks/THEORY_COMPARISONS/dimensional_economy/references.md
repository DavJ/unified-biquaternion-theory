...
# References: Dimensional Economy Comparison

## Primary UBT Documents

1. **Jaroš, D.** (2026).
   *UBT vs. Competing Theories: Dimensional Economy and Rigor.*
   Working document, March 2026.
   Repository: `problem_statement` (issue description).

2. **Jaroš, D.** (2025–2026).
   `consolidation_project/appendix_E2_SM_geometry.tex`
   §1: ℂ⊗ℍ ≅ Mat(2,ℂ) isomorphism.
   §6: SU(2)_L generators and U(1)_Y right action.

3. **Jaroš, D.** (2025–2026).
   `DERIVATION_INDEX.md` — UBT Derivation Status Index.
   Labels: [L0] pure biquaternionic geometry, [L1] one-loop.

4. **Jaroš, D.** (2025–2026).
   `research_tracks/three_generations/st3_complex_time_generations.tex`
   §3: ψ-modes as independent fermion generations.
...
5. **Green, M.B., Schwarz, J.H., Witten, E.** (1987).
   *Superstring Theory*, Vols. 1–2. Cambridge University Press.

6. **Polchinski, J.** (1998).
   *String Theory*, Vols. 1–2. Cambridge University Press.
...
11. **Thiemann, T.** (2007).
    *Modern Canonical Quantum General Relativity*. Cambridge University Press.
...
13. **Furey, C.** (2018).
    ...
    *Physics Letters B* 785, 84–89.
    arXiv:1806.00612.

14. **Dixon, G.M.** (1994).
    *Division Algebras: Octonions, Quaternions, Complex Numbers and the
    Algebraic Design of Physics*. Kluwer Academic.

15. **Baez, J.C.** (2002).
    The Octonions.
    *Bull. Amer. Math. Soc.* 39, 145–205.
    arXiv:math/0105155.
...
17. **Connes, A. & Marcolli, M.** (2008).
    *Noncommutative Geometry, Quantum Fields and Motives*. AMS.

18. **Connes, A. & Lott, J.** (1991).
    Particle models and noncommutative geometry.
    *Nuclear Physics B (Proc. Suppl.)* 18B, 29–47.

19. **Chamseddine, A.H. & Connes, A.** (1997).
...
20. **Hamilton, W.R.** (1844).
    On a new species of imaginary quantities connected with a theory of quaternions.
    *Proc. Royal Irish Academy* 2, 424–434.

21. **Ward, J.P.** (1997).
    *Quaternions and Cayley Numbers: Algebra and Applications*. Kluwer Academic.

22. **Adler, S.L.** (1995).
    *Quaternionic Quantum Mechanics and Quantum Fields*. Oxford University Press.
