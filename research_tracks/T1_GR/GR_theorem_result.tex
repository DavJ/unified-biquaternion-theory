...
% ---- title ----------------------------------------------------------------
\title{\textbf{GR Recovery Theorem}\\[6pt]
  \large Einstein's Field Equations as a Real-Projected Limit\\
  of Unified Biquaternion Theory\\[4pt]
  \normalsize Track T1\_GR — Theorem Result Document}
...
\begin{proposition}[Levi-Civita connection and curvature, standard \PROVED]
