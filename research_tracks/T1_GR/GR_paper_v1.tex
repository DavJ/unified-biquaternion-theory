...
% Deliverable: Flagship paper manuscript — full journal submission draft
% Target venues: Journal of Mathematical Physics / Classical and Quantum Gravity
% Theorem result document: GR_theorem_result.tex
% Theorem chain: theorem_chain.tex
% Standalone theorem: theorem_statement.tex
% Assumptions: assumptions.md
% Gaps: proof_gap_list.md
% Reviewer responses: reviewer_attack_responses.md
...
\title{\textbf{General Relativity as a Real-Projected Limit\\
  ...
  \large Track T1\_GR — Flagship Paper Draft}
...
\[
  ...
  \{\gamma^\mu, \gamma^\nu\} = 2\eta^{\mu\nu}.
\]
By Hurwitz's theorem~\cite{hurwitz1922}, $\HH$ is the unique normed division
...
\begin{itemize}
  ...
  \item \textbf{Connes--Lott noncommutative geometry}~\cite{connes1996}:
