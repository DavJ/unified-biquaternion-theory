...
\begin{proposition}[Global vanishing of mixed term for $\Theta_0=\mathbf{1}_2$, \textbf{[Prop.]}]
For the refined ansatz
\[
\Theta(x,t)=a(t)e^{ix^k e_k}\mathbf{1}_2,
\]
the off-diagonal metric components satisfy $g_{0i}=0$ globally.
\end{proposition}
...
FRW metric globally from $\Theta = a(t)e^{ix^k e_k}\Theta_0$: \textbf{[Prop.]}\\
Friedmann equations from UBT: \textbf{[Prop.]} — conditional on global FRW metric\\
