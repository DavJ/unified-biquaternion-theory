...
we have
\[
\partial_\mu\Theta=\big[(\dot a/a)\delta_{\mu 0}+i e_\mu\big]\Theta.
\]
For isotropic $\Theta_0$, mixed terms cancel and the metric bilinear gives
\[
g_{\mu\nu}
=\frac{\mathrm{Re}[\mathrm{Tr}(\partial_\mu\Theta\cdot\partial_\nu\Theta^\dagger)]}{\mathcal N}
=a^2(t)\,\mathrm{diag}(-1,+1,+1,+1)
\]
up to normalization and coordinate redefinition.
This keeps the refined ansatz compatible with global FRW structure at
proposition level, but the cancellation of the mixed $g_{0i}$ terms
still needs a fully global proof away from the isotropic ansatz simplification.
...
%──────────────────────────────────────────────────────────────────────────────
\begin{statusbox}
Off-diagonal $g_{0i}=0$ globally: \textbf{[Prop. pending]}\\
...
GAP-C status: \textbf{OPEN} — first global step still pending
\end{statusbox}
%──────────────────────────────────────────────────────────────────────────────
