...
\chapter{Fine-Structure Constant Programme: What Is Derived and What Is Not}
\label{ch:alpha}
...
\end{quote}
The live sources of status are \texttt{STATUS.md},
\texttt{WHAT\_IS\_PROVED.md}, and
\texttt{canonical/alpha/ALPHA\_MASTER\_STATUS.md}.  Historical texts using the
phrase ``fit-free alpha derivation'' do not override these ledgers.

\section{The conditional winding potential}
...
\section{The \(N_{\rm eff}\) audit: two counts must not be conflated}
...
\section{Why the theta/Mellin route is still worth studying}
