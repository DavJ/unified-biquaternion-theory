...
\chapter{Complex-Time Continuation and Ward Identities}
\label{ch:ct-scheme}
...
\section{Ward--Takahashi identity: the standard argument}
...
\section{Transversality of the photon self-energy}
...
\section{The controlled UBT bridge}
...
\section{Why the archived \(\mathcal R_{\rm UBT}=1\) text is not imported}
...
\section{Connection to the theta chapter}
