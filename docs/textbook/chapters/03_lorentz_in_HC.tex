...
\chapter{Lorentz Geometry on the Hermitian Slice of \(\mathbb H_{\mathbb C}\)}
\label{ch:lorentz-hc}

\section{Classical foundation: \(\mathrm{Herm}(2,\mathbb C)\)}
...
\section{The \(SL(2,\mathbb C)\) action}
...
\section{Translation into biquaternion notation}
...
\section{Why this matters for UBT}
...
\section{A concrete boost as a check}
...
\section{Live sources and historical note}
...
\texttt{appendix\_P6\_lorentz\_in\_HC.tex} survives in the historical archive,
