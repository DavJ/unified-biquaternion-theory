...
\subsection{Mode orthogonality versus template non-orthogonality}
...
\subsection{Fourier transform in real time}
...
\subsection{Mellin transform in imaginary time}
...
\section{Mellin is Fourier in logarithmic coordinates}
...
\section{The present slice and a time-twisted zeta family}
...
\subsection{Rational times: Hurwitz-zeta decomposition}
...
\section{Rational-time revivals and quadratic Gauss sums}
...
\section{Theta mode sum and Feynman winding sum}
...
\section{Where prime numbers do and do not enter}

\subsection{The Euler product at the untwisted slice}
...
\subsection{Local Euler-factor pole lattices}
...
\subsection{Vertical Fourier spectrum and prime powers}
...
\subsection{Prime counting and zeta-zero frequencies}
...
\section{The operator question behind the whole picture}
