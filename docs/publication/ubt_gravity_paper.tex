...
\begin{enumerate}
  \item \textbf{Zerilli potential (even-parity)} \OPEN\ \Ltwo:
        ...
        \end{equation}
        contains a rational denominator $(2r+3M)^2$ not reproduced by
        a single-component biquaternion Ansatz.  A coupled two-component
        Ansatz ($H_0$, $H_2$ metric perturbation functions) is needed;
        see \texttt{research\_tracks/research/graviton\_schwarzschild.tex}~§7.
