...
%
% LEGACY / SUPERSEDED DOCUMENT
% This report was auto-generated in 2025/2026 and contains alpha derivation claims
% that are superseded by the current canonical status in:
%   canonical/alpha/ALPHA_MASTER_STATUS.md
% Alpha is NOT DERIVED. The claim that alpha^{-1} = 137.036 is reproduced "exactly"
% is historical only. Gap G137-B remains open.
% All "VERIFIED" statuses below are historical and do not reflect current canonical position.
