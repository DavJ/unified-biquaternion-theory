...
% === Numerical Data (CSV) ===
\section*{Numerical Data from Computation (CSV-fed)}

\subsection*{Computed $\alpha$ samples (from CSV)}
We present a few computed points of $\alpha(\mu)$ exported by our strict two-loop pipeline.
All numeric values in the tables below are read \emph{from CSV files} generated by code in this repository.
