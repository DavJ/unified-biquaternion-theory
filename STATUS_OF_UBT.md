# 2026-07-19 — Paired-connection reduction and exact curved-GR no-go
...
- **GAP-10I-PAIR-GR — CLOSED AS NO-GO [L1]:** this pure Lorentz pairing makes
  a torsion-free tetrad generated by one \(\Theta\) imply
  \(\nabla_\mu V^\nu=\delta_\mu{}^\nu\).  Hence it admits only a
  concurrent/homothetic branch and excludes Schwarzschild with \(M\ne0\).
- **GAP-10I-2S — NARROWED [L1]:** the general two-sided derivative
  \[
  ...
  curvature intertwining rather than zero curvature.  The remaining relative
  left/right component must be derived as composite or auxiliary and shown not
  to add propagating degrees of freedom.
...
| Pure Lorentz pairing implies a concurrent vector and excludes generic curved GR/Schwarzschild M!=0 | PROVED NO-GO [L1] | same |
...
| GAP-10I-PAIR-GR — generic GR under the pure Lorentz pair | CLOSED AS NO-GO [L1] |
| GAP-10I-2S — derive a nontrivial relative bimodule action without propagating fields | NARROWED |
