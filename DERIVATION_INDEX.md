...
| Schwarzschild spatial metric from explicit Θ₀ | **Proved [L1]** | `research_tracks/research/schwarzschild_from_theta.tex` | g(r)=r·Ψ²; f'(r)=Ψ·√(2M/r); g_ij=Ψ⁴·δ_ij verified numerically; temporal component recovered analytically via complex-time phase sector |
...
| Full Schwarzschild metric from explicit Θ₀ (spatial + temporal) | **Proved [L1]** | `research_tracks/research/schwarzschild_from_theta.tex §5`; **canonical**: `canonical/geometry/biquaternionic_vacuum_solutions.tex §3` | Spatial isotropic sector is numerically verified; temporal component g_tt is recovered analytically from complex time τ=t+iψ with ψ-phase derivative structure |
...
| Result | Status | Notes |
|--------|--------|-------|
| Schwarzschild metric from explicit Θ₀ (temporal component g_tt) | **Proved [L1]** | Complex-time ansatz Θ₀=e^{iΦ(r)}·[f·1+g·e_r]; g_tt=-Φ² is recovered analytically from ψ-winding |
| Graviton dispersion in Schwarzschild background | **Closed [L1/STD] in the even-parity sector after UBT metric-chain reduction** | `research_tracks/research/graviton_schwarzschild.tex §5,§6`; **canonical: `canonical/geometry/gr_completion_attempt.tex` Thm. thm:regge_wheeler (odd sector), `canonical/gr_closure/zerilli_derivation.tex` (even sector)**; `docs/publication/ubt_gravity_paper.tex §4` | v59–v69 establish linearised Schwarzschild perturbation reduction and Regge–Wheeler odd-parity closure. Even-parity Zerilli closure is documented in `canonical/gr_closure/zerilli_derivation.tex` for vacuum Schwarzschild modes with \ell \ge 2, using standard Chandrasekhar/RWZ machinery after the UBT metric-chain reduction. |
