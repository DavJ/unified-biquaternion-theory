...
| FPE ↔ E-L (full biquaternionic) | **Partially Proved** — v62: U(1)/Abelian sector Proved [L0] (commutator vanishes); SU(2)/SU(3) Sketch (commutator correction identified: ∇_Q[(∇_Q H), Θ]; ordering prescription pending); v69: Cartan subalgebra sector Proved (commutator=0 on diagonal generators); physical vacuum sector Partially Proved (Cartan alignment of ⟨Θ⟩); off-diagonal (W±, gluons) Open — ordering prescription from S[Θ] needed | `canonical/qm_emergence/step4_fpe_equivalence.tex §6,§7`, `ARCHIVE/archive_legacy/consolidation_project/FPE_verification/step5_noncommutativity.tex` | [∂_T,∇_Q²]=0; left FPE from S[Θ]; scalar-H case closed; Gap G3 reduced; Gap G1 CLOSED for scalar sector (step1_fpe_check.tex §1.3.1); v62: U(1) Gap G3 closed; SU(2)/SU(3) correction terms identified explicitly. v69: Cartan sector [T^diag,T^diag]=0 → FPE↔EL proved; physical vacuum ⟨Θ⟩ aligned with Cartan (Higgs direction) → correction vanishes; off-diagonal sector open |
