...
| α⁻¹ = 137 (bare value) | **Semi-empirical** | `ARCHIVE/archive_legacy/historical_versions/status/STATUS_ALPHA.md` | Follows from framework given B=46.3 |
| α⁻¹ = 137.036 (full value) | **Semi-empirical** | `ARCHIVE/archive_legacy/historical_versions/status/STATUS_ALPHA.md` | + two-loop QED correction |
...
> ⭐ **Canonical source for SU(3)**: `ARCHIVE/archive_legacy/consolidation_project/appendix_G_internal_color_symmetry.tex`  
...
| SU(2)_L chirality (not SU(2)_L×SU(2)_R) | **Proved [L1]** | `ARCHIVE/archive_legacy/consolidation_project/chirality_derivation/step1_psi_parity.tex`, `step2_chirality_result.tex`, `step3_gap_C1_resolution.tex` | ψ-parity P_ψ acts as γ⁵ (Proved); odd winding n>0 = left-handed (Proved); Gap C1 closed: W± vertex P_ψ-odd because no W_R coupling in S[Θ] (Thm. gap_C1) — see step3 |

---

## Three Fermion Generations

> ⭐ **Canonical Hecke sources**: `docs/reports/hecke_lepton/` (numerical) + `ARCHIVE/archive_legacy/consolidation_project/hecke_bridge/motivation.tex` (theoretical)  
...
| Result | Status | File | Notes |
|--------|--------|------|-------|
| Prime selection by V_eff(n) minimum | **Proven** [L1] | `ARCHIVE/archive_legacy/historical_versions/status/STATUS_ALPHA.md §4`, `Appendix_H_Theta_Phase_Emergence.tex §H.7a` | Robust regardless of coupling type |
...
| Prime selection (V_eff minimum) | **Proven** | `ARCHIVE/archive_legacy/historical_versions/status/STATUS_ALPHA.md §4` | Independent of coupling type; robust claim |
...
*Added 2026-03-06. Source verification: `ARCHIVE/archive_legacy/consolidation_project/FPE_verification/`.*

| Result | Status | File | Notes |
|--------|--------|------|-------|
| ℂ⊗ℍ ≅ Mat(2,ℂ) algebra isomorphism | **Proven** [L0] | `ARCHIVE/archive_legacy/consolidation_project/FPE_verification/step3_dirac_emergence.tex §2` | Standard algebra; generators map to Pauli matrices |
| Pauli matrices σᵢ from quaternion generators | **Proven** [L0] | `ARCHIVE/archive_legacy/consolidation_project/FPE_verification/step3_dirac_emergence.tex §3` | Direct from isomorphism; not postulated |
| Dirac γ^μ from ℂ⊗ℍ ⊗ ℂ⊗ℍ tensor product | **Proven** [L0] | `ARCHIVE/archive_legacy/consolidation_project/FPE_verification/step3_dirac_emergence.tex §4` | γ^μ in Weyl rep. = σ₁⊗𝟙, iσ₂⊗σᵢ; Clifford relation verified |
...
| Schrödinger structure from Im(∂_τΘ = □Θ) | **Sketch** [L0] | `ARCHIVE/archive_legacy/consolidation_project/FPE_verification/step2_schrodinger_emergence.tex §5` | ∂_ψΦ = −2i∇²Φ follows analytically; diffusion coeff. 𝒟=ℏ/(2m) is assumed (Gap S1) |
...
| Biquaternionic FPE with Θ = Σ exp[πB(n)·H(T)] | **Sketch** [L0] | `ARCHIVE/archive_legacy/consolidation_project/FPE_verification/step1_fpe_check.tex` | Scalar sector numerically verified (see tools/verify_fpe.py); three gaps remain: G1 (A(Q) assumed), G2 (consistency condition on H), G3 (non-commutativity) |
| Massless Dirac equation from 𝒟Θ = 0 (spinorial sector) | **Sketch** [L0] | `ARCHIVE/archive_legacy/consolidation_project/FPE_verification/step3_dirac_emergence.tex §6` | Algebraic structure proved; spinorial subspace constraint not derived from S[Θ] (Gap D1) |
| Born rule |Θ|² = probability density | **Proved [L0]** | `ARCHIVE/archive_legacy/consolidation_project/FPE_verification/step7_born_rule.tex` | Sc[Θ†Θ] is conserved by FPE (∂_T∫P dQ=0); Born rule follows without postulate; see step7 |
...
| FPE ↔ Euler–Lagrange equivalence (scalar sector) | **Proven** [L0] | `ARCHIVE/archive_legacy/consolidation_project/FPE_verification/step4_fpe_equivalence.tex` | Algebraic identity under conditions C1 (∇²H=0) and C2 (∇H⊥∇Θ); script tools/verify_fpe_equivalence.py — ALL CHECKS PASSED |
| Three projections: GR, QM, statistical mechanics | **Proven** [L0] | `ARCHIVE/archive_legacy/consolidation_project/FPE_verification/step4_fpe_equivalence.tex §4` | Re(∂_tΘ=□Θ) → GR/KG; Im(∂_ψΘ=□Θ) → QM/Schrödinger; full FPE → stat.mech. Definitionally equivalent projections of one field equation, not emergent |
...
*Source: `ARCHIVE/archive_legacy/consolidation_project/qed_phi_const/`. Script: `tools/verify_qed_phi_const.py`.*
...
| Result | Status | File | Notes |
|--------|--------|------|-------|
| U(1)\_EM unbroken at φ=const | **Proven** [L0] | `ARCHIVE/archive_legacy/consolidation_project/qed_phi_const/step1_u1_protection.tex` | q\_φ=0 (neutral scalar); m²\_γ=0 exact; no Higgs mechanism for EM |
| Electron mass m\_e=y·v at φ=const | **Sketch** [L1] | `ARCHIVE/archive_legacy/consolidation_project/qed_phi_const/step2_electron_mass.tex` | Structural: identical to SM Higgs; Gaps Y1 (derive y) and Y2 (derive v) open |
| δB(φ)=0 at one loop — α(μ) running unchanged | **Proven** [L1] | `ARCHIVE/archive_legacy/consolidation_project/qed_phi_const/step3_beta_function.tex` | Outcome A: UV divergence mass-independent; φ-loop absent (q\_φ=0); standard QED running exact |
| Schwinger term a\_e=α/(2π) at φ=const | **Proven** [L1] | `ARCHIVE/archive_legacy/consolidation_project/qed_phi_const/step4_schwinger_term.tex` | Massless photon (Step 1) + Dirac vertex (Step 2) → identical 1-loop diagram; φ-correction ~10⁻¹⁶ (unobservable) |
| Lamb shift 1057.8 MHz at φ=const | **Sketch** [L1] | `ARCHIVE/archive_legacy/consolidation_project/qed_phi_const/step5_lamb_shift.tex` | Structural: reduction to Steps 1–4 complete; explicit UBT path-integral computation lacking (Gap L1) |
| QED reproducibility summary | **Substantially Proved** [L1] | `ARCHIVE/archive_legacy/consolidation_project/qed_phi_const/step6_qed_summary.tex` | 3 proved + 2 sketch; minimum criterion (U(1)\_EM unbroken) met; script passes all checks |
...
*Added 2026-03-06. Task: UBT_v29_task2_chirality. Source: `ARCHIVE/archive_legacy/consolidation_project/chirality_derivation/`.*
...
| P_ψ maps modes n → -n (ψ-parity) | **Proven** [L0] | `ARCHIVE/archive_legacy/consolidation_project/chirality_derivation/step1_psi_parity.tex §2` | Def. 1; exact algebraic statement |
| ∂_ψ anti-commutes with P_ψ | **Proven** [L0] | `ARCHIVE/archive_legacy/consolidation_project/chirality_derivation/step1_psi_parity.tex §3` | Lem. 2; direct calculation |
| P_ψ acts as γ⁵ in ψ-sector | **Proven** [L0] | `ARCHIVE/archive_legacy/consolidation_project/chirality_derivation/step1_psi_parity.tex §4` | Prop. 3; [P_ψ, γ^μ∇_μ]=0 and {P_ψ, γ⁵∂_ψ}=0 |
| Preferred ψ-circle orientation (matter n>0 by CPT) | **Proven** [L0] | `ARCHIVE/archive_legacy/consolidation_project/chirality_derivation/step1_psi_parity.tex §5` | Lem. 4; P_ψ = CP in ψ-sector |
| SU(2)_L on odd modes ℋ₋ | **Proved [L1]** | `ARCHIVE/archive_legacy/consolidation_project/chirality_derivation/step1_psi_parity.tex §6`, `step3_gap_C1_resolution.tex` | Thm. 5; Gap C1 closed (no W_R in S[Θ]) — proved from S[Θ] action |
...
*Added 2026-03-06. Task: UBT_v29_task3_8pi. Source: `ARCHIVE/archive_legacy/consolidation_project/8pi_common_origin.tex`. Script: `tools/verify_8pi_connection.py`.*

| Result | Status | File | Notes |
|--------|--------|------|-------|
| 8π in G_μν = 8πG T_μν from dim(ℍ) | **Structural** [L0] | `ARCHIVE/archive_legacy/consolidation_project/8pi_common_origin.tex §2` | 16πG = dim_ℝ(ℍ) × vol(S²) × G = 4 × 4π × G; structural not coincidental |
| B₀ = 8π from dim_ℂ(ℂ⊗ℍ) = 4 | **Proven** [L1] | `ARCHIVE/archive_legacy/consolidation_project/8pi_common_origin.tex §3`, `ARCHIVE/archive_legacy/consolidation_project/N_eff_derivation/step2_vacuum_polarization.tex` | B₀ = 2π × dim_ℂ(ℂ⊗ℍ) = 8π; script verify_8pi_connection.py ALL PASS |
| Common algebraic ancestor: dim 4 | **Structural** [L0] | `ARCHIVE/archive_legacy/consolidation_project/8pi_common_origin.tex §4` | dim_ℝ(ℍ) = dim_ℂ(Mat(2,ℂ)) = 4; both 8π's share this factor |
| N_phases = 3 and spin-trace = 1/3: algebraically independent | **Proven** [L0] | `ARCHIVE/archive_legacy/consolidation_project/8pi_common_origin.tex §3 Thm. 3` | Numerical equality in d=4 is coincidental; cancellation gives dim_ℂ(ℂ⊗ℍ) = 4 |
| Unified theorem: single origin for both 8π's | **Open** | `ARCHIVE/archive_legacy/consolidation_project/8pi_common_origin.tex §5` | Would require deriving 1/(16πG) from S[Θ] directly; deep unification OPEN |

---

## FPE Equivalence — QM/GR/Stat-Mech Unification (Track: CORE)

*Added 2026-03-06. Task: UBT_v29_task1_fpe_equivalence. Source: `ARCHIVE/archive_legacy/consolidation_project/FPE_verification/step4_fpe_equivalence.tex`. Script: `tools/verify_fpe_equivalence.py`.*
...
> ⭐ **Canonical source**: `canonical/bridges/GR_chain_bridge.tex` + `ARCHIVE/archive_legacy/consolidation_project/GR_closure/` chain  
...
three-level taxonomy and `ARCHIVE/archive_legacy/consolidation_project/GR_closure/theta_vs_metric_variation_note.tex`
...
| Result | Status | File | Notes |
|--------|--------|------|-------|
| G_μν = 8πG T_μν from δS_total[g,Θ]/δg^μν = 0 | **Proven** [L1] | `ARCHIVE/archive_legacy/consolidation_project/T_munu_derivation/step3_einstein_with_matter.tex` | Hilbert variation; standard variational GR sector |
| T_μν from Hilbert prescription | **Proven** [L1] | `ARCHIVE/archive_legacy/consolidation_project/T_munu_derivation/step3_einstein_with_matter.tex` | δS_matter/δg^μν = -(√-g/2)T_μν |
| ∇^μ T_μν = 0 from Bianchi identity | **Proven** [L1] | `ARCHIVE/archive_legacy/consolidation_project/T_munu_derivation/step3_einstein_with_matter.tex` | Contracted Bianchi; no free parameters |
| Lorentzian signature (-,+,+,+) from AXIOM B | **Proven** [L0] | `ARCHIVE/archive_legacy/consolidation_project/GR_closure/step3_signature_theorem.tex §Lorentzian Signature from AXIOM B` | Complex time τ=t+iψ → Cl_{1,3}(ℝ) → e₀²=-1 → g₀₀<0; signature is theorem not choice |
| Metric non-degeneracy for A_UBT class | **Proven** [L0] | `ARCHIVE/archive_legacy/consolidation_project/GR_closure/step2_nondegeneracy.tex` | Linear independence of ∂_μΘ ↔ det(g)≠0; degenerate configs explicitly identified |
| Derivative-based ≡ tetrad-based metric formula | **Proven** [L0] | `ARCHIVE/archive_legacy/consolidation_project/GR_closure/step1_metric_bridge.tex` | Under E_μ = ∂_μΘ; single canonical metric definition |
| GR chain summary (Θ→g→Γ→R→Einstein) | **Proved [L1]** | `ARCHIVE/archive_legacy/consolidation_project/GR_closure/GR_chain_summary.tex` | Steps 1-5 proved; Step 6 off-shell open [L2]; see summary doc |
| N is scale-fixing, not signature-fixing | **Proved [L0]** | `ARCHIVE/archive_legacy/consolidation_project/GR_closure/step3_signature_theorem.tex` | Explicitly documented in step1_metric_bridge.tex remark |
| UBT vs sigma model distinction | **Documented** | `ARCHIVE/archive_legacy/consolidation_project/GR_closure/step1_metric_bridge.tex` | Three key differences stated |
...
> ⭐ **Canonical sources**: `ARCHIVE/archive_legacy/consolidation_project/mirror_sector/README.md` + `docs/reports/hecke_lepton/mirror_world_139.md`  
> Topic index: `canonical/THEORY/topic_indexes/mirror_sector_index.md`

| Result | Status | File | Notes |
|--------|--------|------|-------|
| V_eff(137) < V_eff(139) for same B | **NUMERICAL OBSERVATION** | `ARCHIVE/archive_legacy/consolidation_project/mirror_sector/vacuum_stability.tex` | Calibrated to our sector |
| n=139 is NOT a discrete local min of V_{B_137} | **PROVED NUMERICALLY** | `ARCHIVE/archive_legacy/consolidation_project/mirror_sector/vacuum_stability.tex` | V(138) < V(139); ascending branch |
| n*=139 is global min of branch B'=B_139 | **MOTIVATED CONJECTURE** | `ARCHIVE/archive_legacy/consolidation_project/mirror_sector/vacuum_stability.tex` | ΔB/B=1.21%; two independent sectors |
| Mirror sector is fully stable | **FOLLOWS FROM CONJECTURE** | `ARCHIVE/archive_legacy/consolidation_project/mirror_sector/vacuum_stability.tex` | No false vacuum; no Coleman tunnelling |
...
| Mirror matter as dark matter candidate | **CONJECTURE** | `ARCHIVE/archive_legacy/consolidation_project/mirror_sector/README.md` | Gravitational coupling only; Foot-Volkas precedent |

---

## Hecke Bridge (ℂ⊗ℍ ↔ Modular Forms)

> ⭐ **Canonical sources**: `docs/reports/hecke_lepton/` + `ARCHIVE/archive_legacy/consolidation_project/hecke_bridge/motivation.tex`  
> Topic index: `canonical/THEORY/topic_indexes/hecke_index.md`

| Result | Status | File | Notes |
|--------|--------|------|-------|
| Weights k=2,4,6 from n-th ψ-mode | **MOTIVATED CONJECTURE** | `ARCHIVE/archive_legacy/consolidation_project/hecke_bridge/motivation.tex §2` | k=2n for n-th generation; kinetic/quartic/sextic terms in S[Θ] |
| Level N=7, μ(Γ₀(7))=8 = dim_ℝ(ℂ⊗ℍ) | **MOTIVATED CONJECTURE** | `ARCHIVE/archive_legacy/consolidation_project/hecke_bridge/motivation.tex §3` | Index coincidence suggestive; not proved |
| Trivial character χ=1 from ℤ-rationality | **MOTIVATED CONJECTURE** | `ARCHIVE/archive_legacy/consolidation_project/hecke_bridge/motivation.tex §4` | ℂ⊗ℍ over ℤ → ℚ-rational forms |
| Three forms (not one, not five) | **MOTIVATED CONJECTURE** | `ARCHIVE/archive_legacy/consolidation_project/hecke_bridge/motivation.tex §5` | Three ψ-modes; algebraic derivation OPEN |
