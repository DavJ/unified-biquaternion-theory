...
| Born rule |Θ|² = probability density | **Proved [L0]** | `canonical/qm_emergence/step7_born_rule.tex` | Sc[Θ†Θ] is conserved by FPE (∂_T∫P dQ=0); Born rule follows without postulate; see step7 |
