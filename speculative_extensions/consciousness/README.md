...
This directory contains speculative material relating to consciousness modelling within the
Unified Biquaternion Theory framework.
...
| File | Description |
|------|-------------|
| `psychons.tex` | Speculative psychon field definition (moved from canonical/) |

## Origin

`psychons.tex` was formerly located at `canonical/consciousness/psychons.tex`.
