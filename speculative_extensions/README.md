...
(`core/canonical/`, `THEORY/`, `consolidation_project/`):
...
directory and the `core/canonical/consciousness/` (now moved to `speculative_extensions/consciousness/`) subdirectory (labeled speculative).
