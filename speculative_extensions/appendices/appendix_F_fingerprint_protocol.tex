...
\textbf{Hypothesis}: CMB power spectrum residuals $(C_\ell^{\text{obs}} - C_\ell^{\Lambda\text{CDM}}) / \sigma_\ell$ contain periodic oscillations at one of the candidate periods $\Delta\ell \in \{8, 16, 32, 64, 128, 255\}$, suggesting discrete spacetime structure.
...
\textbf{Grid Denominator}: 255 (pre-fixed, not tunable)
