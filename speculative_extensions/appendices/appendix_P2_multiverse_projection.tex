...
\begin{itemize}
\item \textbf{Internal gauge transformations}: $\Theta(q) \to U(q)\Theta(q)U^\dagger(q)$ for $U(q) \in SU(3) \times SU(2) \times U(1)$ (where $q$ projects to spacetime point $x = \Pi(q)$)
