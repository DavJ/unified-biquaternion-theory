...
while contributing to the same underlying biquaternionic invariants entering $\mathcal{I}[P]$.
This provides a controlled mechanism for gravitational ``leakage'' across channels without arbitrary mixing.
