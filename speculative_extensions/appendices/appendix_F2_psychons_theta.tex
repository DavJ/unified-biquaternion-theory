...
%% VERSION: v17 Stable Release - SPECULATIVE APPENDIX
%% ================================================
\appendix
\section{Appendix F2: Psychons and the Theta Field (SPECULATIVE)}
\label{app:psychons_speculative}
% removed addcontentsline

\vspace{1em}
\noindent\fbox{\begin{minipage}{0.95\textwidth}
\textbf{WARNING: HIGHLY SPECULATIVE PHILOSOPHICAL HYPOTHESIS WARNING}
...
\item \textbf{The connection between psychons and consciousness is entirely speculative}
...
\textbf{Author Note:} This speculative extension is clearly separated from the core UBT physics which has testable predictions for particle masses and coupling constants.
\end{minipage}}
\vspace{1em}

\paragraph{Note on Complex Time Approximation.}
The psychon formalism uses complex time $\tau = t + i\psi$. While this is appropriate for phenomenological modeling of Abelian-like phase dynamics, the full biquaternionic time structure T = A + iB (Appendix~\ref{sec:8d_time_manifold}) with A = outer chronometric manifold and B = inner phase/subjective time may be more appropriate for consciousness modeling where subjective time perception is central. The complex time approximation should be understood as a simplified first treatment.
